...
public class SchedulingPattern implements NextTime {
	 ...
	 * 	Get the delay in milliseconds until the next time the given cron expression is met.
	 * @return
	 */
	...
	{
		return formatDate(new Date(next(System.currentTimeMillis())), "dd.MM.yyyy HH:mm:ss");
	}
