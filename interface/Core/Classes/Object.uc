...
//__L2 Hunter
native      static final function rotator Vector2Rotator( vector V );
native      static final function vector Rotator2Vector( rotator R );
//Hunter End
...
// Export UObject::execAddParamInt(FFrame&, void* const)
native function AddParamInt(ParamMap a_ParamMap, string a_Key, int a_Value);

// Export UObject::execAddParamINT64(FFrame&, void* const)
native function AddParamINT64(ParamMap a_ParamMap, string a_Key, INT64 a_Value);

// Export UObject::execAddParamFloat(FFrame&, void* const)
native function AddParamFloat(ParamMap a_ParamMap, string a_Key, float a_Value);

// Export UObject::execAddParamString(FFrame&, void* const)
native function AddParamString(ParamMap a_ParamMap, string a_Key, string a_Value);

// Export UObject::execGetParamInt(FFrame&, void* const)
native function bool GetParamInt(ParamMap a_ParamMap, string a_Key, out int a_Result);

// Export UObject::execGetParamINT64(FFrame&, void* const)
native function bool GetParamINT64(ParamMap a_ParamMap, string a_Key, out INT64 a_Result);

// Export UObject::execGetParamFloat(FFrame&, void* const)
native function bool GetParamFloat(ParamMap a_ParamMap, string a_Key, out float a_Result);

// Export UObject::execGetParamString(FFrame&, void* const)
native function bool GetParamString(ParamMap a_ParamMap, string a_Key, out string a_Result);
