...
function OnOKButtonClick()
{
	...
	MaxMemberCount = clamp( MaxMemberCount, MIN_MEMBER, getMaxMember() );
...
function SetMaxMemberCount( int a_MaxMemberCount )
{
	...
	a_MaxMemberCount = clamp( a_MaxMemberCount, MIN_MEMBER, getMaxMember() );
