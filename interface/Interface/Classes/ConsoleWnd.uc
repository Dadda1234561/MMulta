...
function OnEvent(int Event_ID, String param)
{
	...
	switch(Event_ID)
	{
		...
		case EV_Test_2:
			...
			break;
		case EV_Test_3:
			htm = gfxHtmlAddText("¹ÞA≫ ¾ÆAIAU : ","#FFEE33","22") $ gfxHtmlAddItemTexture(1,32,32,-5) $ brPixel(5) $ gfxHtmlAddItemTexture(2,24,24,-5) $ gfxHtmlAddText("Ca¿iA≫ AaA¸¼I³×¿a!","#00FF00","25") $ br() $ gfxHtmlAddItemTexture(352,32,32,-4) $ gfxHtmlAddText("¸¶¹y≫cAC º¸Aº:","#FF0F20","22") $ gfxHtmlAddText("°i¾cAI","#CC2F3F","24");
