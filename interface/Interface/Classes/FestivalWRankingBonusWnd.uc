//================================================================================
// FestivalWRankingBonusWnd.
// emu-dev.ru
//================================================================================
class FestivalWRankingBonusWnd extends UICommonAPI
	dependson(FestivalWRankingWnd);
...
function SetBonusList(array<UIPacket._WRFBonusInfo> bonusInfos)
{
	...
	for(i = 0; i < _bonusInfos.Length; i++)
	{
		...
		if(myAmount < bonusInfos[i].nPoint)
		{
			completedRewardNum--;
			RewardState = REWARD_STATE.non;
		}
		else if(GetReceivedIndexByPoint(bonusInfos[i].nPoint) == -1)
		{
			RewardState = REWARD_STATE.Reward;
		...
		{
			RewardState = REWARD_STATE.Completed;
		}
