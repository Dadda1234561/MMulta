...
defaultproperties
{
    ...
    CyanColor=(B=255,G=255,R=0,A=255)
    BlueColor=(B=255,G=0,R=0,A=255)
    GoldColor=(B=0,G=255,R=255,A=255)
    PurpleColor=(B=255,G=0,R=255,A=255)
    TurqColor=(B=255,G=128,R=0,A=255)
    ...
    CrosshairScale=1
    CrosshairOpacity=1
    ConsoleMessagePosY=1
    FontArray[0]=Font'DefaultFont'
