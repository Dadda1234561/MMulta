...
public class HellboundRemnantInstance extends MonsterInstance
{
	...
	{
		super.reduceCurrentHp(Math.min(damage, getCurrentHp() - 1), attacker, skill, awake, standUp, directHp, canReflectAndAbsorb, transferDamage, isDot, sendReceiveMessage, sendGiveMessage, crit, miss, shld, isStatic);
	}
