...
public class TreasureChestInstance extends ChestInstance
{
	...
	{
		SkillEntry bomb = SkillEntry.makeSkillEntry(SkillEntryType.NONE, TREASURE_BOMB_SKILL_ID, getBombLvl());
		if(bomb != null)
	...
	@Override
	public void onReduceCurrentHp(final double damage, final Creature attacker, Skill skill, final boolean awake, final boolean standUp, boolean directHp, boolean isDot, boolean isStatic)
	{
		if(!isCommonTreasureChest())
			fakeOpen(attacker);
	}
