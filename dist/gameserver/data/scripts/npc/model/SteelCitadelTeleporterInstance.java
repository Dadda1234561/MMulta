...
public class SteelCitadelTeleporterInstance extends NpcInstance
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		{
			player.teleToLocation(new Location(-22208, 277122, -13376));
			return;
		}
		else if(command.equalsIgnoreCase("02_up"))
		{
			player.teleToLocation(new Location(-22208, 277106, -11648));
			return;
		}
		else if(command.equalsIgnoreCase("02_down"))
		{
			player.teleToLocation(new Location(-22208, 277074, -15040));
			return;
		}
		else if(command.equalsIgnoreCase("03_up"))
		{
			player.teleToLocation(new Location(-22208, 277120, -9920));
			return;
		}
		else if(command.equalsIgnoreCase("03_down"))
		{
			player.teleToLocation(new Location(-22208, 277120, -13376));
			return;
		}
		else if(command.equalsIgnoreCase("04_up"))
		{
			player.teleToLocation(new Location(-19024, 277126, -8256));
			return;
		}
		...
		{
			player.teleToLocation(new Location(-19024, 277106, -9920));
			return;
		}
		else if(command.equalsIgnoreCase("06_down"))
		{
			player.teleToLocation(new Location(-22208, 277122, -9920));
			return;
		}
		else if(command.equalsIgnoreCase("07_up"))
		{
			player.teleToLocation(new Location(-19008, 277100, -11648));
			return;
		}
		else if(command.equalsIgnoreCase("07_down"))
		{
			player.teleToLocation(new Location(-19024, 277122, -8256));
			return;
		}
		else if(command.equalsIgnoreCase("08_up"))
		{
			player.teleToLocation(new Location(-19008, 277100, -13376));
			return;
		}
		else if(command.equalsIgnoreCase("08_down"))
		{
			player.teleToLocation(new Location(-19008, 277106, -9920));
			return;
		}
		else if(command.equalsIgnoreCase("09_up"))
		{
			player.teleToLocation(new Location(14602, 283179, -7500));
			return;
		}
