...
{
	private static final SkillEntry BLOOD_SACRIFICE_DECREASE_SPEED_1 = SkillEntry.makeSkillEntry(SkillEntryType.NONE, 15537, 1);	// Blood Sacrifice: Decrease Speed (1 lvl.)
	private static final SkillEntry BLOOD_SACRIFICE_DECREASE_SPEED_2 = SkillEntry.makeSkillEntry(SkillEntryType.NONE, 15537, 2);	// Blood Sacrifice: Decrease Speed	(2 lvl.)
	...
	public void onAction(Player player, boolean shift)
	{
		...
		player.sendActionFailed();
		player.getMovement().stopMove(false);
