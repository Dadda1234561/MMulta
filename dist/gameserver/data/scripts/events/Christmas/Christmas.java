...
public class Christmas implements OnInitScriptListener
{
	...
	{
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, -79256, 248056, -3321, 57343, 0)); // Faeron
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, -114760, 256120, -1537, 49151, 0)); // Talking Island
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 208392, 87560, -1052, 24575, 0)); // Arcan
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 80968, 148168, -3472, 0, 0)); // Giran
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 146920, 26680, -2230, 16383, 0)); // Aden
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 147464, -56984, -2784, 3742, 0)); // Goddard
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 44584, -48408, -822, 16383, 0)); // Rune
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 82904, 54232, -1521, 49151, 0)); // Oren
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 87592, -141720, -1344, 35323, 0)); // Schuttgart
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 111816, 218968, -3568, 16383, 0)); // Heine
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 16376, 142792, -2731, 16383, 0)); // Dion
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, -14824, 123144, -3143, 0, 0)); // Gludio
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, -80728, 150632, -3069, 40959, 0)); // Gludin

		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, -79240, 248104, -3321, 0, 0)); // Faeron
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, -114712, 256120, -1537, 0, 0)); // Talking Island
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 208344, 87512, -1052, 0, 0)); // Arcan
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 80968, 148216, -3494, 0, 0)); // Giran
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 146856, 26680, -2230, 0, 0)); // Aden
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 147448, -56936, -2803, 0, 0)); // Goddard
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 44536, -48424, -822, 0, 0)); // Rune
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 82968, 54232, -1521, 0, 0)); // Oren
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 87624, -141784, -1368, 0, 0)); // Schuttgart
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 111768, 218952, -3568, 0, 0)); // Heine
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 16328, 142792, -2731, 0, 0)); // Dion
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, -14840, 123192, -3141, 0, 0)); // Gludio
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, -80696, 150584, -3069, 0, 0)); // Gludin
	}
