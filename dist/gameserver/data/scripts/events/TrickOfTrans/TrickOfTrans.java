...
public class TrickOfTrans implements OnInitScriptListener
{
	...
	{
		// Эвент Менеджер
		_em_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 147992, 28616, -2295, 0, 0)); // Aden
		_em_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 81919, 148290, -3472, 51432, 0)); // Giran
		_em_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 18293, 145208, -3081, 6470, 0)); // Dion
		_em_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, -14694, 122699, -3122, 0, 0)); // Gludio
		_em_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, -81634, 150275, -3155, 15863, 0)); // Gludin

		// Сундуки
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, 148081, 28614, -2274, 2059, 0)); // Aden
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, 147918, 28615, -2295, 31471, 0)); // Aden
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, 147998, 28534, -2274, 49152, 0)); // Aden
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, 148053, 28550, -2274, 55621, 0)); // Aden
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, 147945, 28563, -2274, 40159, 0)); // Aden
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, 82012, 148286, -3472, 61567, 0)); // Giran
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, 81822, 148287, -3493, 29413, 0)); // Giran
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, 81917, 148207, -3493, 49152, 0)); // Giran
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, 81978, 148228, -3472, 53988, 0)); // Giran
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, 81851, 148238, -3472, 40960, 0)); // Giran
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, 18343, 145253, -3096, 7449, 0)); // Dion
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, 18284, 145274, -3090, 19740, 0)); // Dion
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, 18351, 145186, -3089, 61312, 0)); // Dion
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, 18228, 145265, -3079, 21674, 0)); // Dion
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, 18317, 145140, -3078, 55285, 0)); // Dion
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, -14584, 122694, -3122, 65082, 0)); // Gludio
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, -14610, 122756, -3143, 13029, 0)); // Gludio
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, -14628, 122627, -3122, 50632, 0)); // Gludio
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, -14697, 122607, -3143, 48408, 0)); // Gludio
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, -14686, 122787, -3122, 12416, 0)); // Gludio
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, -81745, 150275, -3134, 32768, 0)); // Gludin
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, -81520, 150275, -3134, 0, 0)); // Gludin
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, -81628, 150379, -3134, 16025, 0)); // Gludin
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, -81696, 150347, -3155, 22854, 0)); // Gludin
		_ch_spawns.add(NpcUtils.spawnSingle(CHESTS_ID, -81559, 150332, -3134, 3356, 0)); // Gludin
	}
