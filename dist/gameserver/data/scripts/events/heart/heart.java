...
public class heart implements OnInitScriptListener
{
	...
	{
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 146936, 26654, -2208, 16384, 0)); // Aden
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 82168, 148842, -3464, 7806, 0)); // Giran
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 82204, 53259, -1488, 16384, 0)); // Oren
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 18924, 145782, -3088, 44034, 0)); // Dion
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 111794, 218967, -3536, 20780, 0)); // Heine
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, -14539, 124066, -3112, 50874, 0)); // Gludio
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 147271, -55573, -2736, 60304, 0)); // Goddard
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 87801, -143150, -1296, 28800, 0)); // Shuttgard
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, -80684, 149458, -3040, 16384, 0)); // Gludin
	}
