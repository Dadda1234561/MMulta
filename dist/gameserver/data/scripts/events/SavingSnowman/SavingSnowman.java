...
public class SavingSnowman implements OnInitScriptListener
{
	...
	{
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 81921, 148921, -3467, 16384, 0));
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 146405, 28360, -2269, 49648, 0));
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 19319, 144919, -3103, 31135, 0));
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, -82805, 149890, -3129, 16384, 0));
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, -12347, 122549, -3104, 16384, 0));
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 110642, 220165, -3655, 61898, 0));
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 116619, 75463, -2721, 20881, 0));
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 85513, 16014, -3668, 23681, 0));
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 81999, 53793, -1496, 61621, 0));
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 148159, -55484, -2734, 44315, 0));
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 44185, -48502, -797, 27479, 0));
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 86899, -143229, -1293, 8192, 0));

		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 81961, 148921, -3467, 0, 0));
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 146445, 28360, -2269, 0, 0));
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 19319, 144959, -3103, 0, 0));
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, -82845, 149890, -3129, 0, 0));
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, -12387, 122549, -3104, 0, 0));
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 110602, 220165, -3655, 0, 0));
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 116659, 75463, -2721, 0, 0));
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 85553, 16014, -3668, 0, 0));
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 81999, 53743, -1496, 0, 0));
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 148199, -55484, -2734, 0, 0));
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 44185, -48542, -797, 0, 0));
		_spawns.add(NpcUtils.spawnSingle(CTREE_ID, 86859, -143229, -1293, 0, 0));
	}
	...
	public void buff(Player player, NpcInstance npc, String[] param)
	{
		...
		player.altOnMagicUse(player, SkillEntry.makeSkillEntry(SkillEntryType.NONE, 23017, 1));
		...
		for(Servitor s : player.getServitors())
		{
			...
			s.altOnMagicUse(s, SkillEntry.makeSkillEntry(SkillEntryType.NONE, 23017, 1));
		}
	}
	...
	// Индюк захватывает снеговика Location spawnPoint = new Location(83464, 149176, -3409); //getRandomSpawnPoint();
	public void captureSnowman()
	{		Location[] points_stage2 = {
				new Location(113736, 190712, -3564),
                new Location(157640, 64152, -3561),
                new Location(63768, 11672, -3348),
				new Location(142184, 154344, -2866)};
		Location spawnPoint = new Location(Rnd.get(points_stage2)); //getRandomSpawnPoint();
		...
		// Спауним снеговика spawnSingle(CTREE_ID, 81961, 148921, -3467, 0, 0));
