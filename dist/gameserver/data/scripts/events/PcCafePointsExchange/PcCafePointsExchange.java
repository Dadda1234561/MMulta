...
public class PcCafePointsExchange implements OnInitScriptListener
{
	...
	{
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 15880, 143704, -2888, 0, 0)); //Dion
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 83656, 148440, -3430, 32768, 0)); //Giran
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 147272, 27416, -2228, 16384, 0)); //Aden
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 42808, -47896, -822, 49152, 0)); //Rune
	}
