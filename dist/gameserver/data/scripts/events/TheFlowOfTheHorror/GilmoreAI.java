				...
				case 2:
					switch(step_stage2)
					{
						...
						case 2:
							...
							return true;
						case 3:
							actor.getStat().addFuncs(new FuncMul(Stats.MAGIC_ATTACK_SPEED, 0x40, actor, 5, StatsSet.EMPTY));
							actor.getStat().addFuncs(new FuncMul(Stats.INFLICTS_P_DAMAGE_POWER, 0x40, actor, 10, StatsSet.EMPTY));
							actor.getStat().addFuncs(new FuncMul(Stats.INFLICTS_M_DAMAGE_POWER, 0x40, actor, 10, StatsSet.EMPTY));
							actor.getStat().addFuncs(new FuncMul(Stats.RUN_SPEED, 0x40, actor, 3, StatsSet.EMPTY));
							actor.addSkill(SkillEntry.makeSkillEntry(SkillEntryType.NONE, 1467, 1));
							actor.sendChanges();
							step_stage2 = 4;
							return true;
						case 4:
							...
							return true;
						case 10:
							actor.getStat().removeFuncsByOwner(this);
							step_stage2 = 11;
							return true;
					}
			}
		...
		for(NpcInstance npc : World.getAroundNpc(actor, 1000, 200))
			if(Rnd.chance(10) && npc != null && npc.getNpcId() == 20235)
			{
				...
				if(Rnd.chance(20))
				{
					...
					if(skillEntry != null)
						addTaskCast(monster, skillEntry);
				}
				else
