...
public class March8 implements OnInitScriptListener
{
	...
	{
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, -14823, 123567, -3143, 8192, 0)); // Gludio
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, -83159, 150914, -3155, 49152, 0)); // Gludin
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 18600, 145971, -3095, 40960, 0)); // Dion
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 82158, 148609, -3493, 60, 0)); // Giran
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 110992, 218753, -3568, 0, 0)); // Hiene
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 116339, 75424, -2738, 0, 0)); // Hunter Village
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 81140, 55218, -1551, 32768, 0)); // Oren
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 147148, 27401, -2231, 2300, 0)); // Aden
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 43532, -46807, -823, 31471, 0)); // Rune
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 87765, -141947, -1367, 6500, 0)); // Schuttgart
		_spawns.add(NpcUtils.spawnSingle(EVENT_MANAGER_ID, 147154, -55527, -2807, 61300, 0)); // Goddard
	}
