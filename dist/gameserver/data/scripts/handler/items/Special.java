...
public class Special extends SimpleItemHandler
{
	...
	protected boolean useItemImpl(Player player, ItemInstance item, boolean ctrl)
	{
		...
		switch(itemId)
		{
			...
			case 46919:
			case 80956:
				return useClassEquipBox(player, ctrl);
			default:
				return false;
		}
	}
	
	private boolean useClassEquipBox(Player player, boolean ctrl)
	{
		final int HEAVY_ARMOR_BOX = 46924;
		final int LIGHT_ARMOR_BOX = 46925;
		final int ROBE_BOX = 46926;
		final int PAULINA_APOCALYPSE_CUTTER = 47008;
		final int PAULINA_APOCALYPSE_SLASHER = 47009;
		final int PAULINA_APOCALYPSE_AVENGER = 47010;
		final int PAULINA_APOCALYPSE_FIGHTER = 47011;
		final int PAULINA_APOCALYPSE_STORMER = 47012;
		final int PAULINA_APOCALYPSE_THROWER = 47013;
		final int PAULINA_APOCALYPSE_SHOOTER = 47014;
		final int PAULINA_APOCALYPSE_BUSTER = 47015;
		final int PAULINA_APOCALYPSE_CASTER = 47016;
		final int PAULINA_APOCALYPSE_RETRIBUTER = 47017;
		final int PAULINA_APOCALYPSE_DUAL_SWORD = 47018;
		final int PAULINA_APOCALYPSE_DUAL_DAGGER = 47019;
		final int SHIELD_R = 47026;
		final int SIGIL_R = 47037;
		final int ARROW_R = 18550;
		final int BOLT_R = 19443;
		final int SS_R = 33780;
		final int BSS_R = 33794;
		
		if ((player.isDualClassActive() && ItemFunctions.deleteItem(player, 80956, 1))//
				|| (player.isBaseClassActive() && ItemFunctions.deleteItem(player, 46919, 1)))
		{
			ItemFunctions.addItem(player, SS_R, 100_000);
			ItemFunctions.addItem(player, BSS_R, 100_000);
			...
			/*switch (player.getClassId())
			{
				...
				case ISS_DOMINATOR:
				{
					ItemFunctions.addItem(player, HEAVY_ARMOR_BOX, 1);
					ItemFunctions.addItem(player, PAULINA_APOCALYPSE_CUTTER, 1);
					ItemFunctions.addItem(player, SHIELD_R, 1);
					return true;
				}
				case TYRR_DUELIST:
				{
					ItemFunctions.addItem(player, HEAVY_ARMOR_BOX, 1);
					ItemFunctions.addItem(player, PAULINA_APOCALYPSE_DUAL_SWORD, 1);
					return true;
				}
				case TYRR_DREADNOUGHT:
				{
					ItemFunctions.addItem(player, HEAVY_ARMOR_BOX, 1);
					ItemFunctions.addItem(player, PAULINA_APOCALYPSE_STORMER, 1);
					return true;
				}
				case TYRR_TITAN:
				...
				{
					ItemFunctions.addItem(player, HEAVY_ARMOR_BOX, 1);
					ItemFunctions.addItem(player, PAULINA_APOCALYPSE_SLASHER, 1);
					return true;
				}
				case TYRR_GRAND_KHAVATARI:
				{
					ItemFunctions.addItem(player, HEAVY_ARMOR_BOX, 1);
					ItemFunctions.addItem(player, PAULINA_APOCALYPSE_FIGHTER, 1);
					return true;
				}
				case TYRR_MAESTRO:
				{
					ItemFunctions.addItem(player, HEAVY_ARMOR_BOX, 1);
					ItemFunctions.addItem(player, PAULINA_APOCALYPSE_AVENGER, 1);
					ItemFunctions.addItem(player, SHIELD_R, 1);
					return true;
				}
				...
				{
					ItemFunctions.addItem(player, LIGHT_ARMOR_BOX, 1);
					ItemFunctions.addItem(player, PAULINA_APOCALYPSE_DUAL_DAGGER, 1);
					return true;
				}
				...
				{
					ItemFunctions.addItem(player, LIGHT_ARMOR_BOX, 1);
					ItemFunctions.addItem(player, PAULINA_APOCALYPSE_THROWER, 1);
					ItemFunctions.addItem(player, ARROW_R, 100000);
					return true;
				}
				case YUL_TRICKSTER:
				{
					ItemFunctions.addItem(player, LIGHT_ARMOR_BOX, 1);
					ItemFunctions.addItem(player, PAULINA_APOCALYPSE_SHOOTER, 1);
					ItemFunctions.addItem(player, BOLT_R, 100000);
					return true;
				}
				case FEOH_ARCHMAGE:
				case FEOH_SOULTAKER:
				...
				{
					ItemFunctions.addItem(player, ROBE_BOX, 1);
					ItemFunctions.addItem(player, PAULINA_APOCALYPSE_BUSTER, 1);
					ItemFunctions.addItem(player, SIGIL_R, 1);
					return true;
				}
				case ISS_HIEROPHANT:
				...
				{
					ItemFunctions.addItem(player, LIGHT_ARMOR_BOX, 1);
					ItemFunctions.addItem(player, PAULINA_APOCALYPSE_RETRIBUTER, 1);
					return true;
				}
				case AEORE_CARDINAL:
				...
				{
					ItemFunctions.addItem(player, ROBE_BOX, 1);
					ItemFunctions.addItem(player, PAULINA_APOCALYPSE_CASTER, 1);
					ItemFunctions.addItem(player, SIGIL_R, 1);
					return true;
				}
				case EVISCERATOR:
	...
	private boolean use21903(Player player, boolean ctrl)
	{
		...
		player.doCast(SkillEntry.makeSkillEntry(SkillEntryType.NONE, 22298, 1), player, false);
	...
	private boolean use21904(Player player, boolean ctrl)
	{
		...
		player.doCast(SkillEntry.makeSkillEntry(SkillEntryType.NONE, 22299, 1), player, false);
	...
	private boolean use17268(Player player, boolean ctrl)
	{
		...
		player.doCast(SkillEntry.makeSkillEntry(SkillEntryType.NONE, 9179, 1), player, false);
	...
	private boolean use17604(Player player, boolean ctrl)
	{
		...
		NpcInstance npc3 = NpcUtils.spawnSingle(32938, Location.findPointToStay(player.getLoc(), 50, 100, player.getGeoIndex()), 120000L);
		player.setVar("CrystalsSpawn", "1", System.currentTimeMillis() + 1000L);
		return true;
	}
		...
		if(qs != null && qs.getCond() == 1)
		{
			if(player.getTarget() instanceof NpcInstance)
			{
				if(((NpcInstance) player.getTarget()).getNpcId() == 19296)
				{
					...
					player.forceUseSkill(SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 9584, 1), npc);
					return true;
				}
			}
		}
