...
public class FirstHuntMonsterManeater extends ProgressDailyMissionHandler
{
    public static final int MANEATER = 20062;
    ...
    private class HandlerListeners implements OnKillListener
    {
        ...
        public void onKill(Creature actor, Creature victim)
        {
            ...
            if (player != null && victim.getNpcId() == MANEATER)
            {
