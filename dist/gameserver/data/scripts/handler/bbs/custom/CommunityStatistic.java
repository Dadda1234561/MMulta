...
public class CommunityStatistic extends CustomCommunityHandler
{
	...
	private void loadStatistic()
	{
		...
		try
		{
			...
			statement = con.prepareStatement("SELECT c.obj_Id, c.char_name, c.pkkills, c.pvpkills, c.onlinetime, cs.exp FROM characters AS c LEFT JOIN character_dualclasses AS cs ON c.obj_Id=cs.char_obj_id AND cs.type=" + DualClassType.BASE_CLASS.ordinal());
	...
	private void updateStatistic(Player player)
	{
		...
		stat.lvl = player.getBaseDualClass() != null ? player.getBaseDualClass().getLevel() : player.getLevel();
