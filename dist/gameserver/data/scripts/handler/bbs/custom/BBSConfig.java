...
public class BBSConfig implements OnLoadScriptListener
{
	...
	public static int NOBLE_SERVICE_COST_ITEM_ID_2;
	public static long NOBLE_SERVICE_COST_ITEM_COUNT_2;
	...
	public static int CHANGE_LEVEL_SERVICE_COST_ITEM_ID;
	public static long CHANGE_LEVEL_SERVICE_COST_ITEM_COUNT;

	public static int CHANGE_RACE_SERVICE_COST_ITEM_ID;
	public static long CHANGE_RACE_SERVICE_COST_ITEM_COUNT;
	...
	public void onLoad()
	{
		...
		NOBLE_SERVICE_COST_ITEM_ID_2 = properties.getProperty("NOBLE_SERVICE_COST_ITEM_ID_2", 57);
		NOBLE_SERVICE_COST_ITEM_COUNT_2 = properties.getProperty("NOBLE_SERVICE_COST_ITEM_COUNT_2", 1000000000L);
		...
		// Change level service
		CHANGE_LEVEL_SERVICE_COST_ITEM_ID = properties.getProperty("CHANGE_LEVEL_SERVICE_COST_ITEM_ID", 57);
		CHANGE_LEVEL_SERVICE_COST_ITEM_COUNT = properties.getProperty("CHANGE_LEVEL_SERVICE_COST_ITEM_COUNT", 100000000L);

		CHANGE_RACE_SERVICE_COST_ITEM_ID = properties.getProperty("CHANGE_RACE_SERVICE_COST_ITEM_ID", 4037);
		CHANGE_RACE_SERVICE_COST_ITEM_COUNT = properties.getProperty("CHANGE_RACE_SERVICE_COST_ITEM_COUNT", 1000L);
