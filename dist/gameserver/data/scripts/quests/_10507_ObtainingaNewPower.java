 ...
 * @author Edoo
 */
public class _10507_ObtainingaNewPower extends Quest
{
	private static class ChangeLevelListener implements OnLevelChangeListener
	{
		...
		{
			QuestState qs = player.getQuestState(10507);
			if(qs == null)
				return;

			if ((qs.getCond() == 1) && (qs.getQuestItemsCount(PROOF_OF_STRENGTH) >= 160000) && (player.getLevel() >= 110))
				qs.setCond(2);
		}
	}
	...
	// NPC
		...
		// Rewards
		private static final int DIGNITY_OF_THE_EXALTED = 80970;
		// Mobs
	...
	public _10507_ObtainingaNewPower()
	{
		...
		addQuestCompletedCheck("no_level.htm", 10879);
	}
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		switch (event)
		{
			case "lionel_hunter_q10507_03.htm":
			case "lionel_hunter_q10507_04.htm":
			{
				break;
			}
			case "lionel_hunter_q10507_05.htm":
			{
				st.setCond(1);
				break;
			}
			case "lionel_hunter_q10507_08.htm":
			{
				if (st.getCond() == 2)
				{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		switch (npcId)
		{
			case LIONEL:
			{
				...
				{
					case 0:
						return "lionel_hunter_q10507_01.htm";
					case 1:
						return "lionel_hunter_q10507_06.htm";
					case 2:
						return "lionel_hunter_q10507_07.htm";
				}
				break;
			}
		}
	...
	{
		if ((qs.getCond() == 1) && (qs.getQuestItemsCount(PROOF_OF_STRENGTH) < 160000) && ArrayUtils.contains(MONSTERS, npc.getNpcId()))
		{
			qs.giveItems(PROOF_OF_STRENGTH, 1);
			if ((qs.getQuestItemsCount(PROOF_OF_STRENGTH) >= 160000) && qs.getPlayer().getLevel() >= 110)
			{
				qs.setCond(2);	
			}
			else
