...
public class _194_SevenSignsMammonsContract extends Quest
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			st.setCond(3);
			st.giveItems(AthebaldtsIntroduction, 1, false);
		}
		...
		else if(event.equalsIgnoreCase("colin_q194_6.htm"))
		{
			...
			st.setCond(7);
			negateSpeedBuffs(player);
			SkillHolder.getInstance().getSkill(6202, 1).getEffects(player, player, false);
		}
		else if(event.equalsIgnoreCase("tess_q194_2.htm"))
		{
			st.setCond(8);
			st.giveItems(GrandmaTessCandyPouch, 1, false);
		}
		...
		else if(event.equalsIgnoreCase("colin_q194_9.htm"))
		{
			...
			st.setCond(10);
			negateSpeedBuffs(player);
			SkillHolder.getInstance().getSkill(6203, 1).getEffects(player, player, false);
		}
		else if(event.equalsIgnoreCase("kuta_q194_2.htm"))
		{
			st.setCond(11);
			st.giveItems(NativesGlove, 1, false);
		}
		...
		else if(event.equalsIgnoreCase("colin_q194_11a.htm"))
		{
			...
			negateSpeedBuffs(player);
			SkillHolder.getInstance().getSkill(6201, 1).getEffects(player, player, false);
		}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		else if(npcId == Colin)
		{
			...
			else if(cond == 4 && player.getTransformId() == 0)
				htmltext = "colin_q194_11.htm";
			else if(cond == 7 && player.getTransformId() == 0)
				htmltext = "colin_q194_12.htm";
			else if(cond == 10 && player.getTransformId() == 0)
				htmltext = "colin_q194_13.htm";
			else if((cond == 4 || cond == 7 || cond == 10) && player.getTransformId() != 0)
