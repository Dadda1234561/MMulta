...
public class _11027_PathofDestinyOvercome extends Quest
{
	private static class PlayerEnterListener implements OnPlayerEnterListener
	{
		...
		{
			QuestState questState = player.getQuestState(11027);
			if((questState == null) && (player.getLevel() >= MIN_LEVEL)//
					&& (player.getClassLevel() == ClassLevel.THIRD)//
	...
	private static class ClassChangeListener implements OnClassChangeListener
	{
		...
		{
			final QuestState qs = player.getQuestState(11027);
			if ((qs != null) && qs.isCompleted() && (player.getClassLevel() == ClassLevel.AWAKED)//
					...
					&& (player.getRace() != Race.ERTHEIA))
			{
				...
				{
					case 148: // Sigel Phoenix Knight
					case 149: // Sigel Hell Knight
					case 150: // Sigel Eva's Templar
					case 151: // Sigel Shillien Templar
					{
						qs.giveItems(SIGEL_BOX, 1);
						break;
					}
					case 152: // Tyrr Duelist
					case 153: // Tyrr Dreadnought
					case 154: // Tyrr Titan
					case 155: // Tyrr Grand Khavatari
					case 156: // Tyrr Maestro
					case 157: // Tyrr Doombringer
					{
						qs.giveItems(TYRR_BOX, 1);
						break;
					}
					case 158: // Othell Adventurer
					case 159: // Othell Wind Rider
					case 160: // Othell Ghost Hunter
					case 161: // Othell Fortune Seeker
					{
						qs.giveItems(OTHELL_BOX, 1);
						break;
					}
					case 162: // Yul Sagittarius
					case 163: // Yul Moonlight Sentinel
					case 164: // Yul Ghost Sentinel
					case 165: // Yul Trickster
					{
						qs.giveItems(YUL_BOX, 1);
						break;
					}
					...
					{
						qs.giveItems(FEOH_BOX, 1);
						break;
					}
					case 171: // Iss Hierophant
					case 172: // Iss Sword Muse
					case 173: // Iss Spectral Dancer
					case 174: // Iss Dominator
					case 175: // Iss Doomcryer
					{
						qs.giveItems(ISS_BOX, 1);
						break;
					}
					case 176: // Wynn Arcana Lord
					case 177: // Wynn Elemental Master
					case 178: // Wynn Spectral Master
					{
						qs.giveItems(WYNN_BOX, 1);
						break;
					}
					case 179: // Aeore Cardinal
					case 180: // Aeore Eva's Saint
					case 181: // Aeore Shillien Saint
					{
						qs.giveItems(AEORE_BOX, 1);
						break;
					}
				}
			}
	...
	private static final int SIGEL_BOX = 32264;
	private static final int TYRR_BOX = 32265;
	private static final int OTHELL_BOX = 32266;
	private static final int YUL_BOX = 32267;
	private static final int FEOH_BOX = 32268;
	private static final int WYNN_BOX = 32269;
	private static final int ISS_BOX = 32270;
	private static final int AEORE_BOX = 32271;
	...
	public _11027_PathofDestinyOvercome()
	{
		...
		addClassLevelCheck("bad_class.htm", false, ClassLevel.THIRD);
		addQuestCompletedCheck("low_level.htm", 11026);
	}
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		switch (event)
		{
			...
			case "reclous_q11027_02.htm":
			{
				st.addExpAndSp(392_513_005, 353_261);
				st.setCond(3);
				break;
			}
			case "reclous_q11027_03.htm":
			{
				st.setCond(4);
				giveStoryBuff(npc, player);
				break;
			...
			case "reclous_q11027_07.htm":
			{
				st.addExpAndSp(581_704_958, 523_534);
				st.setCond(6);
				break;
			}
			case "reclous_q11027_08.htm":
			{
				st.setCond(7);
				giveStoryBuff(npc, player);
				break;
			...
			case "reclous_q11027_17.htm":
			{
				st.addExpAndSp(452_984_693, 407_684);
				st.setCond(12);
				break;
			}
			case "reclous_q11027_18.htm":
			{
				st.setCond(13);
				giveStoryBuff(npc, player);
				break;
			...
			case "tarti_q11027_06.htm":
			{
				st.addExpAndSp(1_176_372_111L, 527_586);
				st.giveItems(ADENA_ID, 420_000);
				st.setCond(18);
				giveStoryBuff(npc, player);
				player.sendPacket(new ExShowScreenMessage(NpcString.AWAKENING_IS_AVAILABLENGO_SEE_TARTI_IN_THE_TOWN_OF_GLUDIO_TO_START_THE_CLASS_TRANSFER, 5000, ExShowScreenMessage.ScreenMessageAlign.TOP_CENTER, false));
				break;
			}
			case "tarti_q11027_07.htm":
			{
				st.setCond(19);
				break;
			}
			case "tarti_q11027_08.htm":
			{
				if (player.getLevel() >= 85)
				{
					st.setCond(20);
					return "tarti_q11027_09.htm";
				}
				break;
			}
			case "raymond_q11027_02.htm":
			{
				st.setCond(21);
			...
			case "mysterious_wizard_q11027_04.htm":
			{
				if(st.getCond() == 22)
				{
					if(checkReflection(reflection))
			...
			case "mysterious_wizard_q11027_06.htm":
			{
				if(st.getCond() == 22)
				{
					if(checkReflection(reflection))
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		switch (npcId)
		{
			case TARTI:
			{
				...
				{
					case 0:
						return "tarti_q11027_01.htm";
					case 1:
						return "tarti_q11027_03.htm";
					case 17:
						return "tarti_q11027_05.htm";
					case 18:
					case 19:
						return "tarti_q11027_07.htm";
					case 20:
						return "tarti_q11027_10.htm";
					case 24:
					{
						if (st.haveQuestItem(ATELIA))
						{
							return "tarti_q11027_11.htm";
						}
						break;
					}
				}
			...
			case RECLOUS:
			{
				...
				{
					case 2:
						return "reclous_q11027_01.htm";
					case 3:
						return "reclous_q11027_02.htm";
					case 4:
						return "reclous_q11027_05.htm";
					case 5:
						return "reclous_q11027_06.htm";
					case 6:
						return "reclous_q11027_07.htm";
					case 7:
						return "reclous_q11027_10.htm";
					case 8:
						return "reclous_q11027_11.htm";
					case 9:
						return "reclous_q11027_12.htm";
					case 10:
						return "reclous_q11027_15.htm";
					case 11:
						return "reclous_q11027_16.htm";
					case 12:
						return "reclous_q11027_17.htm";
					case 13:
						return "reclous_q11027_20.htm";
					case 14:
						return "reclous_q11027_21.htm";
					case 15:
						return "reclous_q11027_22.htm";
					case 16:
						return "reclous_q11027_25.htm";
				}
				break;
			}
			case RAYMOND:
			{
				...
				{
					case 20:
						return "raymond_q11027_01.htm";
					case 24:
						return "raymond_q11027_04.htm";
				}
				break;
			}
			case GERETH:
			{
				...
				{
					case 21:
						return "gereth_q11027_01.htm";
					case 22:
						return "gereth_q11027_06.htm";
					case 23:
					{
						st.setCond(24);
						return "gereth_q11027_07.htm";
					}
					case 24:
						return "gereth_q11027_08.htm";
				}
				break;
			}
			case KAIN_VAN_HALTER:
			{
				if(cond == 22)
				{
					...
					if(talk == 0 || talk == 1)
						return "kain_van_halter_q11027_01.htm";
					else if(talk == 2)
						return "kain_van_halter_q11027_02.htm";
				}
				else if(cond == 23)
					return "kain_van_halter_q11027_03.htm";
				break;
			}
			case GRAIL:
			{
				if(cond == 22)
					return "grail_q11027_01.htm";
				break;
			}
		}
		...
		if(npcId == MYSTERIOUS_WIZARD)
		{
			if(cond == 22)
			{
				...
				if(talk == 0 || talk == 1)
				{
					...
					return "mysterious_wizard_q11027_01.htm";
				}
			}
		}
		return null;
