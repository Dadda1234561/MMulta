		...
		else if(cond == 1)
		{
			...
			else if(event.equals("caradine_q0247_05.htm"))
			{
				...
				if(st.getPlayer().getLevel() >= 75)
				{
					...
					st.finishQuest();
					if (st.getPlayer().getNobleType() == NobleType.NONE)
					{
					...
					st.getPlayer().sendPacket(new ExShowScreenMessage(NpcString.CONGRATULATIONS_YOU_ARE_NOW_A_NOBLESSE, 10000, ExShowScreenMessage.ScreenMessageAlign.TOP_CENTER, false));
