 ...
 * @author Edoo
 */
public class _1901_StormIsleFurtiveDeal extends Quest
{
	// NPC
	...
	public _1901_StormIsleFurtiveDeal()
	{
		super(PARTY_ONE, DAILY);
		addStartNpc(HORA);
		addTalkId(HORA);
		addKillNpcWithLog(1, NpcString.ERADICATE_MONSTERS_ON_STORM_ISLE_2.getId(), A_LIST, 200, MONSTERS);
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		switch (event)
		{
			case "hora_q1901_02.htm":
			case "hora_q1901_03.htm":
			{
				break;
			}
			case "hora_q1901_04.htm":
			{
				st.setCond(1);
				break;
			}
			case "hora_q1901_07.htm":
			{
				if (st.getCond() == 2)
				{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		switch (npcId)
		{
			case HORA:
			{
				...
				{
					case 0:
						return "hora_q1901_01.htm";
					case 1:
						return "hora_q1901_06.htm";
					case 2:
						return "hora_q1901_05.htm";
				}
				break;
			}
		}
