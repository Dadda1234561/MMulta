 ...
 * @author Edoo
 */
public class _10879_ExaltedGuideToPower extends Quest
{
	private static class ChangeLevelListener implements OnLevelChangeListener
	{
		...
		{
			QuestState qs = player.getQuestState(10879);
			if(qs == null)
				return;

			if ((qs.getCond() == 1) && (qs.getQuestItemsCount(PROOF_OF_PRIDE) >= 80000) && (player.getLevel() >= 107))
				qs.setCond(2);
		}
	}
	...
	public _10879_ExaltedGuideToPower()
	{
		...
		addQuestCompletedCheck("no_level.htm", 10873);
	}
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		switch (event)
		{
			case "lionel_hunter_q10879_03.htm":
			case "lionel_hunter_q10879_04.htm":
			{
				break;
			}
			case "lionel_hunter_q10879_05.htm":
			{
				st.setCond(1);
				break;
			}
			case "lionel_hunter_q10879_08.htm":
			{
				if (st.getCond() == 2)
				{
					st.takeAllItems(PROOF_OF_PRIDE);
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		switch (npcId)
		{
			case LIONEL:
			{
				...
				{
					case 0:
						return "lionel_hunter_q10879_01.htm";
					case 1:
						return "lionel_hunter_q10879_06.htm";
					case 2:
						return "lionel_hunter_q10879_07.htm";
				}
				break;
			}
		}
	...
	{
		if ((qs.getCond() == 1) && (qs.getQuestItemsCount(PROOF_OF_PRIDE) < 80000) && ArrayUtils.contains(MONSTERS, npc.getNpcId()))
		{
			qs.giveItems(PROOF_OF_PRIDE, 1);
			if ((qs.getQuestItemsCount(PROOF_OF_PRIDE) >= 80000) && qs.getPlayer().getLevel() >= 107)
			{
				qs.setCond(2);	
			}
			else
