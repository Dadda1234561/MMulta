...
public class _11026_PathofDestinyConviction extends Quest
{
	private static class PlayerEnterListener implements OnPlayerEnterListener
	{
		...
		{
			QuestState questState = player.getQuestState(11026);
	...
	public _11026_PathofDestinyConviction()
	{
		...
		addClassLevelCheck("bad_class.htm", false, ClassLevel.SECOND);
		addQuestCompletedCheck("low_level.htm", 11025);
	}
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		switch (event)
		{
			...
			case "pio_q11026_03.htm":
			{
				st.setCond(3);
				st.addExpAndSp(14_281_098, 12_852);
				break;
			}
			case "pio_q11026_05.htm":
			{
				st.setCond(4);
				giveStoryBuff(npc, player);
				break;
			...
			case "pio_q11026_08.htm":
			{
				st.addExpAndSp(30_949_789, 27_854);
				st.setCond(6);
				break;
			}
			case "pio_q11026_10.htm":
			{
				st.setCond(7);
				giveStoryBuff(npc, player);
				break;
			...
			case "tarti_q11026_06.htm":
			{
				st.addExpAndSp(834_929_477, 595_042);
				st.giveItems(ADENA_ID, 240_000);
				st.setCond(15);
				player.sendPacket(new ExShowScreenMessage(NpcString.THIRD_CLASS_TRANSFER_IS_AVAILABLENGO_SEE_TARTI_IN_THE_TOWN_OF_GLUDIO_TO_START_THE_CLASS_TRANSFER, 5000, ExShowScreenMessage.ScreenMessageAlign.TOP_CENTER, false));
				break;
			}
			case "tarti_q11026_07.htm":
			{
				st.setCond(16);
				break;
			}
			case "tarti_q11026_08.htm":
			{
				if (player.getLevel() >= 76)
				{
					return "tarti_q11026_09.htm";
				}
				break;
			}
			case "tarti_q11026_10.htm":
			{
				st.setCond(17);
				break;
			}
			case "raymond_q11026_02.htm":
			{
				st.setCond(18);
				break;
			}
			...
			case "kain_van_halter_q11026_11.htm":
			{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		switch (npcId)
		{
			case TARTI:
			{
				...
				{
					case 0:
						return "tarti_q11026_01.htm";
					case 1:
						return "tarti_q11026_03.htm";
					case 14:
						return "tarti_q11026_05.htm";
					case 15:
						return "tarti_q11026_06.htm";
					case 16:
					{
						if (st.getPlayer().getLevel() >= 76)
							return "tarti_q11026_09.htm";
						else
							return "tarti_q11026_08.htm";
					}
					case 17:
						return "tarti_q11026_10.htm";
					case 19:
						return "tarti_q11026_11.htm";
				}
				break;
			}
			case PIO:
			{
				...
				{
					case 2:
						return "pio_q11026_01.htm";
					case 3:
						return "pio_q11026_04.htm";
					case 4:
						return "pio_q11026_06.htm";
					case 5:
						return "pio_q11026_07.htm";
					case 6:
						return "pio_q11026_09.htm";
					case 7:
						return "pio_q11026_11.htm";
					case 8:
						return "pio_q11026_12.htm";
					case 9:
						return "pio_q11026_14.htm";
					case 10:
						return "pio_q11026_15.htm";
					case 11:
						return "pio_q11026_16.htm";
					case 12:
						return "pio_q11026_18.htm";
					case 13:
						return "pio_q11026_20.htm";
				}
				break;
			}
			case RAYMOND:
			{
				...
				{
					case 17:
						return "raymond_q11026_01.htm";
					case 18:
						return "raymond_q11026_03.htm";
					case 19:
						return "raymond_q11026_04.htm";
				}
				break;
			}
			...
			{
				if(st.getCond() == 18)
					return "kain_van_halter_q11026_01.htm";
			}
		}
	...
	public String onFirstTalk(NpcInstance npc, Player player)
	{
		...
		if(npcId == MYSTERIOUS_WIZARD)
		{
			...
			if(st.getCond() == 18)
				return "mysterious_wizard_q11026_01.htm";
		}
		return null;
	}
