...
public class _195_SevenSignsSecretRitualofthePriests extends Quest
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			st.setCond(2);
			st.giveItems(GuardsoftheDawnIdentityCard, 1, false);
		}
		else if(event.equalsIgnoreCase("raymond_q195_3.htm"))
		{
			...
			SkillHolder.getInstance().getSkill(6204, 1).getEffects(player, player, false);
			st.setCond(3);
		}
		...
		{
			st.giveItems(EmperorShunaimansContract, 1, false);
