...
public class Isthina extends Reflection
{
	...
	public class ZoneListener implements OnZoneEnterLeaveListener
	{
		...
		public void onZoneEnter(Zone zone, Creature cha)
		{
			...
			{
				ThreadPoolManager.getInstance().schedule(new CloseDoorTask(), 5000L);
	...
	private class StartIsthinaOpenMovie implements Runnable
	{
		@Override
		public void run()
		{
	...
	private class SpawnIsthina implements Runnable
	{
		@Override
		public void run()
		{
	...
	private class SpawnBallista implements Runnable
	{
	...
	private class BallistaPrepareTask implements Runnable
	{
		private NpcInstance _boss;
	...
	private class ClearInstance implements Runnable
	{
		@Override
		public void run()
		{
			startCollapseTimer(1, true);
		}
	}

	private class CloseDoorTask implements Runnable {
		@Override
		public void run() {
			closeDoor(14220100);
			closeDoor(14220101);
