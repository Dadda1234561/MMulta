...
public class MemoryOfDisaster extends Reflection
{
	...
	private class ScreenMessageTask implements Runnable
	{
	...
	private class SpawnRoginTask implements Runnable
	{
		/**
		 * 
		 */
	...
	private class Scene1 implements Runnable
	{
		/**
		 * 
		 */
	...
	private class Scene2 implements Runnable
	{
		/**
		 * 
		 */
	...
	private class Scene3 implements Runnable
	{
		/**
		 * 
		 */
	...
	private class EndInstanceTask implements Runnable
	{
		/**
		 * 
		 */
	...
	private class ShowHtmlTask implements Runnable
	{
