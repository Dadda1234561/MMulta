...
public class SpiculaZero extends Reflection
{
	...
	// SCHEDULED TASKS.
	private class Stage1BozRoutine implements Runnable
	{
...
//			_npc.getFlags().getInvulnerable().start();
	...
	private class Stage3BozRoutine implements Runnable
	{
		private final NpcInstance _npc;
	...
	private class Stage4BozRoutine implements Runnable
	{
		private final NpcInstance _npc;
	...
	private class Stage4BozRoutineSub implements Runnable
	{
		private final NpcInstance _npc;
		private final int _bozNum;
	...
	protected void onCreate()
	{
		...
		closeDoor(OFFSET_DOOR); closeDoor(STAGE1_DOOR); closeDoor(STAGE2_DOOR); closeDoor(STAGE3_DOOR); closeDoor(STAGE4_DOOR);
