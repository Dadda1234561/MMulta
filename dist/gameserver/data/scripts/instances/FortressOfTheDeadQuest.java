 ...
 * @author Bonux
**/
public class FortressOfTheDeadQuest extends Reflection
{
	// Monster's
	...
	// Spawn groups
	private static final String SPAWN_GROUP_1 = "fortress_of_the_dead_q_1";
	private static final String SPAWN_GROUP_2 = "fortress_of_the_dead_q_2";
	private static final String SPAWN_GROUP_3 = "fortress_of_the_dead_q_3";
	...
	public class EndFirstScene implements Runnable
	{
		@Override
		public void run()
		{
	...
	public void removeObject(GameObject o)
	{
		...
		if(o.isNpc())
		{
			...
			{
				List<NpcInstance> npcs = getNpcs(false, VAMPIRIC_SOLDIER);
				if(npcs.isEmpty())
				{
