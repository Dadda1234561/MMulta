...
public class Kimerian extends Reflection
{
	...
	public void onPlayerEnter(final Player player) {
		...
		{
			follower1.getMovement().setFollowTarget(getPlayers().get(0));
			follower2.getMovement().setFollowTarget(getPlayers().get(0));
			follower3.getMovement().setFollowTarget(getPlayers().get(0));
		}
	}
	...
	private class KimerianSupportTask implements Runnable
	{
		@Override
		public void run()
		{
