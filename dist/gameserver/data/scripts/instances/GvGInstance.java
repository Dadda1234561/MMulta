...
public class GvGInstance extends Reflection
{
	...
	public void resurrectAtBase(Player player)
	{
		...
		player.altOnMagicUse(player, SkillEntry.makeSkillEntry(SkillEntryType.NONE, 5660, 2)); // Battlefield Death Syndrome
	...
	public class BossSpawn implements Runnable
	{
		@Override
		public void run()
		{
	...
	public class BattleEnd implements Runnable
	{
		@Override
		public void run()
		{
