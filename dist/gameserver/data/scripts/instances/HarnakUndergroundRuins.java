...
public class HarnakUndergroundRuins extends Reflection
{
	...
	private class SpawnNpcTask implements Runnable
	{
		@Override
		public void run()
		{
			...
			ThreadPoolManager.getInstance().schedule(new Runnable(){
				...
				public void run()
				{
					List<NpcInstance> npcs = getNpcs(true, RAKZAN_ID);
					if(!npcs.isEmpty())
	...
	private class SpawnNpcByPlayerClass implements Runnable
	{
	...
	private class SpawnThirdRoom implements Runnable
	{
		@Override
		public void run()
		{
