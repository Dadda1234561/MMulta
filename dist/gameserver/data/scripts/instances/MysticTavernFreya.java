...
public class MysticTavernFreya extends Reflection
{
	...
	protected void onCreate()
	{
		...
		spawners = spawnByGroup("mystic_tavern_freya_custom_2");
		for(Spawner spawner : spawners)
		{
			for(NpcInstance npcInstance : spawner.getAllSpawned())
			{
		...
		spawners = spawnByGroup("mystic_tavern_freya_custom_4");
		for(Spawner spawner : spawners)
		{
			for(NpcInstance npcInstance : spawner.getAllSpawned())
			{
				npcInstance.addListener(new DeathListener("mystic_tavern_freya_custom_4_1"));
			}
		}
