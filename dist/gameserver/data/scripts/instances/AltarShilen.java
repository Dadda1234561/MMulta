...
public class AltarShilen extends Reflection
{
	...
	private class CloseOpenedDoor implements Runnable
	{

		@Override
		public void run()
		{
			DoorInstance door = getDoor(DoorEnter4);
			if(door != null)
				door.closeMe();

			door = getDoor(DoorEnter5);
			if(door != null)
				door.closeMe();

			door = getDoor(DoorEnter6);
			if(door != null)
				door.closeMe();
		}
	}
	...
	private class DeathListener implements OnDeathListener
	{
		...
		{
			if(self.getNpcId() == 23132 || self.getNpcId() == 23133 || self.getNpcId() == 23134 || self.getNpcId() == 23135 || self.getNpcId() == 23136 || self.getNpcId() == 23137)
			{
				DoorInstance door = getDoor(DoorEnter4);
				if(door != null)
					door.openMe();
			...
			else if(stage == 1 && getNpcs(true, KeyStage1).isEmpty())
			{
				stageStart(2);
			}
			...
			else if(stage == 4 && getNpcs(true, KeyStage2).isEmpty())
			{
				stageStart(5);
			}
			...
			else if((self.getNpcId() == BossStage3_1 && getNpcs(true, BossStage3_2).isEmpty()) || (self.getNpcId() == BossStage3_2 && getNpcs(true, BossStage3_1).isEmpty()))
			{
