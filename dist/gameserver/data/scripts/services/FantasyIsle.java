...
public class FantasyIsle implements OnInitScriptListener
{
	...
	public static void start(NpcInstance temp_npc, String event)
	{
		...
		else if(WALKS.containsKey(event) && temp_npc != null)
		{
			...
			temp_npc.getMovement().moveToLocation(new Location(x, y, z), 0, true);
			startQuestTimer(nextEvent, time, temp_npc);
		}
		else if(event.equals("6") && temp_npc != null)
		{
			Functions.npcSay(temp_npc, TEXT[6]);
			temp_npc.getMovement().moveToLocation(new Location(-56511, -56647, -2008, 36863), 0, true);
			...
			elf.getMovement().moveToLocation(new Location(-56657, -56338, -2008, 33102), 0, true);
		...
		else if(event.equals("7") && temp_npc != null)
		{
			if(temp_npc.getNpcId() == MC)
			{
				...
				temp_npc.getMovement().moveToLocation(new Location(-56698, -56430, -2008, 32768), 0, true);
				startQuestTimer("8", 12000, temp_npc);
			}
			else
			{
				//cancelQuestTimer("social1", npc, null);
				temp_npc.getMovement().moveToLocation(new Location(-56594, -56064, -2008), 0, true);
				startQuestTimer("clean_npc", 9000, temp_npc);
			}
		}
		else if(event.equals("10") && temp_npc != null)
		{
			temp_npc.getMovement().moveToLocation(new Location(-56483, -56665, -2034), 0, true);
		...
		else if(event.equals("11") && temp_npc != null)
		{
			if(temp_npc.getNpcId() == MC)
			{
				...
				temp_npc.getMovement().moveToLocation(new Location(-56698, -56430, -2008), 0, true);
				startQuestTimer("12", 5000, temp_npc);
			}
			else
			{
				temp_npc.getMovement().moveToLocation(new Location(-56343, -56330, -2008), 0, true);
		...
		{
			temp_npc.getMovement().moveToLocation(new Location(-56702, -56340, -2008), 0, true);
		...
		{
			temp_npc.getMovement().moveToLocation(new Location(-56730, -56340, -2008), 0, true);
