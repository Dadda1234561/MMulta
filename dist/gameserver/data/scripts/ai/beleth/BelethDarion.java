...
public class BelethDarion extends DefaultAI
{
	...
	// 0 Stage
	final SkillEntry b_vulcano = getSkill(16158, 1);
	final SkillEntry b_blaze = getSkill(16159, 1);
	final SkillEntry b_flame = getSkill(16160, 1);
	final SkillEntry d_bleed = getSkill(16161, 1);

	// 1 Stage
	final SkillEntry bd_tornado = getSkill(16170, 1);
