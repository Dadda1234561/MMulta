...
public class FreyaThrone extends Fighter
{
	...
	protected void thinkAttack()
	{
		...
		// Ice Ball Cast
		if(!actor.isCastingNow() && !actor.getMovement().isMoving() && _iceballReuseTimer < System.currentTimeMillis() && Rnd.chance(_iceballChance))
        {
		...
		// Death Sentence
		if(!actor.isCastingNow() && !actor.getMovement().isMoving() && _deathsentenceReuseTimer < System.currentTimeMillis() && Rnd.chance(_deathsentenceChance))
		{
		...
		// Freya Anger
		if(!actor.isCastingNow() && !actor.getMovement().isMoving() && _angerReuseTimer < System.currentTimeMillis() && Rnd.chance(_angerChance))
		{
