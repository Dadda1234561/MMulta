...
public class CrystalGolem extends DefaultAI
{
	...
	{
		if(getActor().getMovement().getFollowTarget() != null)
		{
			getActor().setRunning();
			addTaskMove(Location.findPointToStay(getActor().getLoc(), 100, 100, getActor().getGeoIndex()), true, false);
			countfear++;
		}
	...
	private void escape()
	{
		getActor().getMovement().setFollowTarget(null);
