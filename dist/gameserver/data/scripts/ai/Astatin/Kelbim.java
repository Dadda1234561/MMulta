...
{
	// debuffs
	final SkillEntry s_fear = getSkill(23684, 1), s_wave = getSkill(23685, 1), s_shtorm = getSkill(23686, 1), s_shok = getSkill(23695, 1), s_shok2 = getSkill(23696, 1), s_storm = getSkill(23698, 1);

	// damage skills
	final SkillEntry s_fatal = getSkill(23681, 1), s_black = getSkill(23682, 1), s_blade = getSkill(23683, 1);

	// buff skills
	final SkillEntry s_phisdef = getSkill(23689, 1), s_mdef = getSkill(23690, 1), s_celestial = getSkill(23691, 1), s_fury = getSkill(23688, 1), s_reflect = getSkill(23687, 1);

	//StageChange skills
	final SkillEntry s_stage2 = getSkill(23702, 1), s_stage3 = getSkill(23703, 1), s_stage4 = getSkill(23704, 1);
