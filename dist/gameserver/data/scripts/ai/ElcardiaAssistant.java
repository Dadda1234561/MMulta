...
public class ElcardiaAssistant extends DefaultAI
{
	...
	private final SkillEntry vampRage = SkillEntry.makeSkillEntry(SkillEntryType.NONE,6727, 1);
	private final SkillEntry holyResist = SkillEntry.makeSkillEntry(SkillEntryType.NONE,6729, 1);
	private final SkillEntry blessBlood = SkillEntry.makeSkillEntry(SkillEntryType.NONE,6725, 1);
	private final SkillEntry recharge = SkillEntry.makeSkillEntry(SkillEntryType.NONE,6728, 1);
	private final SkillEntry heal = SkillEntry.makeSkillEntry(SkillEntryType.NONE,6724, 1);
	...
	protected boolean thinkActive()
	{
		...
		Creature following = actor.getMovement().getFollowTarget();
		if(following == null || !actor.getMovement().isFollow())
		{
			Player master = getMaster();
			if(master != null)
			{
				actor.getMovement().setFollowTarget(master);
				actor.setRunning();
