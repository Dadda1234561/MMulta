...
public class Sandstorm extends DefaultAI
{
	...
	private static final SkillEntry SKILL1 = SkillEntry.makeSkillEntry(SkillEntryType.NONE,5435, 1);
	private static final SkillEntry SKILL2 = SkillEntry.makeSkillEntry(SkillEntryType.NONE,5494, 1);
	...
	protected boolean thinkActive()
	{
		...
		if(lastThrow + 5000 < System.currentTimeMillis())
			for(Playable target : World.getAroundPlayables(actor, AGGRO_RANGE, AGGRO_RANGE))
				if(target != null && !target.isAlikeDead() && !target.isInvulnerable() && target.isVisible() && GeoEngine.canSeeTarget(actor, target))
				{
	...
	@Override
	protected void onEvtClanAttacked(NpcInstance attacked_member, Creature attacker, int damage)
	{}
