...
public class FortuneBug extends DefaultAI
{
	...
	private static final SkillEntry s_display_bug_of_fortune1 = SkillEntry.makeSkillEntry(SkillEntryType.NONE, 6045, 1);
	private static final SkillEntry s_display_jackpot_firework = SkillEntry.makeSkillEntry(SkillEntryType.NONE, 5778, 1);
	...
	protected boolean thinkActive()
	{
		...
		if(!actor.getMovement().isMoving() && _nextEat < System.currentTimeMillis())
		{
			ItemInstance closestItem = null;
			...
			if(closestItem != null)
				actor.getMovement().moveToLocation(closestItem.getLoc(), 0, true);
		}
	...
	protected void onEvtDead(Creature killer)
	{
		...
		if(killer != null)
		{
			if(i_ai2 == 0)
				...
				actor.broadcastPacket(new MagicSkillUse(actor, s_display_jackpot_firework.getId(), 1, s_display_jackpot_firework.getTemplate().getHitTime(), 0));
