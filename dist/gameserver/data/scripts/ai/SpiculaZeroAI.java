...
public class SpiculaZeroAI extends Fighter
{
	...
	*/
	// SKILLS INFOS.
	private final static SkillEntry DARK_SPHERES = SkillEntry.makeSkillEntry(SkillEntryType.NONE, 15234, 1);
	private final static SkillEntry DARK_WIND = SkillEntry.makeSkillEntry(SkillEntryType.NONE, 15235, 1);
	private final static SkillEntry DARK_THRUST = SkillEntry.makeSkillEntry(SkillEntryType.NONE, 15236, 1);
	private final static SkillEntry DARK_BUSTER = SkillEntry.makeSkillEntry(SkillEntryType.NONE, 15237, 1);
	private final static SkillEntry DARK_BREATH = SkillEntry.makeSkillEntry(SkillEntryType.NONE, 15238, 1);
	...
	private SkillEntry lastCastedSkill = null;
	...
	protected boolean createNewTask()
	{
		...
		if (r_skill != null && ((lastCastedSkill != null && (!r_skill.equals(lastCastedSkill) || Rnd.chance(25))) || lastCastedSkill == null))
		{
			lastSkill = r_skill;
