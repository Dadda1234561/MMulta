...
CREATE TABLE `characters` (
	...
	`symbol_seal_points` FLOAT NOT NULL DEFAULT '0',
    ...
    `rebirthsSub` INT NOT NULL DEFAULT '0',
    `rebirthsPercent` INT NOT NULL DEFAULT '0',
    `rebirthsDivine` INT NOT NULL DEFAULT '0',
    `craftingPoints` INT UNSIGNED NOT NULL DEFAULT '0',
    `craftGaugePoints` INT UNSIGNED NOT NULL DEFAULT '0',
    `lastRebirthTime` BIGINT UNSIGNED NOT NULL DEFAULT '0',
    `gear_score_rank` INT NOT NULL DEFAULT '0',
