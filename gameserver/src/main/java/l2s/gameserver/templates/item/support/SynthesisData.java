...
public class SynthesisData
{
	...
	public SynthesisData(int item1Id, int item2Id, double chance, long commission, ItemData successItemData, ItemData failItemData, int resultEffecttype, int[] locationIds)
	{
		_item1Id = item1Id;
		_item2Id = item2Id;
		_chance = chance;
