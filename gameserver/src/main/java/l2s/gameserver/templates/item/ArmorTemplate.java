...
public final class ArmorTemplate extends ItemTemplate
{
	...
	public ArmorTemplate(StatsSet set)
	{
		...
		String artifactSlotStr = set.getString("artifact_slot", null);
		artifactSlot = artifactSlotStr == null ? null : ArtifactSlot.valueOfXml(artifactSlotStr);
	}
