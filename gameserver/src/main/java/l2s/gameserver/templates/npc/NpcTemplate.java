...
public class NpcTemplate extends CreatureTemplate
{
	...
	public final int _rebirthsToTakeDamage;
	...
	public NpcTemplate(StatsSet set)
	{
		...
		_rebirthsToTakeDamage = set.getInteger("rebirthToTakeDamage", 0);
	...
	public int getRebirthsToTakeDamage()
	{
		return _rebirthsToTakeDamage;
	}
}