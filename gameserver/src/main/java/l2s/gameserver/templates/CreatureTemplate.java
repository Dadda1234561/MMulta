...
public class CreatureTemplate
{
	...
	private final double _baseRaidBossDamage;
	private final double _baseSoulShotDefence;
	private final int _baseDamageDecreaseDif;
	private final double _baseDamageDecreasePer;
	private final int _baseDifLevelForPenalty;
	...
	public CreatureTemplate(StatsSet set)
	{
		...
		_baseRaidBossDamage = set.getDouble("raid_boss_damage", 1.);
		_baseSoulShotDefence = set.getDouble("soulshot_defence", 1.);
		_baseDamageDecreaseDif = set.getInteger("damage_decreace_dif", 1);
		_baseDamageDecreasePer = set.getDouble("damage_decreace_per", 1.);
		_baseDifLevelForPenalty = set.getInteger("dif_level_for_penalty", 0);
	...
	public double getBaseRaidBossDamage()
	{
		return _baseRaidBossDamage;
	}
	public double getBaseSoulShotDefence()
	{
		return _baseSoulShotDefence;
	}

	public int getBaseDamageDecreaseDif()
	{
		return _baseDamageDecreaseDif;
	}

	public double getBaseDamageDecreasePer()
	{
		return _baseDamageDecreasePer;
	}
	public int getBaseDifLevelForPenalty()
	{
		return _baseDifLevelForPenalty;
	}
