...
public class AdminEditChar implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(Enum<?> comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		if(activeChar.getPlayerAccess().CanRename)
			...
			else if(fullString.startsWith("admin_setparam"))
			{
				try
				{
					String val = fullString.substring(15);
					...
					if(st.hasMoreTokens())
					{
						...
						switch(param)
						{
							case "race":
							{
								...
								int isMage = Integer.parseInt(st.nextToken());
								ClassId nearestClassId = getNearestClassId(Race.values()[race], isMage == 1);
								if(nearestClassId != null)
								{
									activeChar.setActiveDualClass(nearestClassId.getId(), true, true);
									activeChar.changeClassInDb(activeChar.getClassId().getId(), nearestClassId.getId(), nearestClassId.getId());
									logoutPlayer(activeChar);
								}
								break;
							}
							case "sex":
							{
								...
								PlayerTemplate template = PlayerTemplateHolder.getInstance().getPlayerTemplate(activeChar.getRace(), activeChar.getClassId(), Sex.values()[value]);
								if(template != null)
								{
									activeChar.setTemplate(template);
	...
	private void logoutPlayer(Player activeChar)
	{
		if(activeChar == null)
			return;

		GameClient client = activeChar.getNetConnection();
		int slot = client.getSlotForObjectId(activeChar.getObjectId());
	...
	private void listCharacters(Player activeChar, int page)
	{
		...
		replyMSG.append("<td width=40><button value=\"Main\" action=\"bypass -h admin_admin\" width=40 height=15 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		replyMSG.append("<td width=180><center>Character Selection Menu</center></td>");
		replyMSG.append("<td width=40><button value=\"Back\" action=\"bypass -h admin_admin\" width=40 height=15 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		...
		replyMSG.append("<edit var=\"character_name\" width=80></td><td><button value=\"Find\" action=\"bypass -h admin_find_character $character_name\" width=40 height=15 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\">");
	...
	public static void showCharacterList(Player activeChar, Player player)
	{
		...
		replyMSG.append("<td width=40><button value=\"Main\" action=\"bypass -h admin_admin\" width=40 height=15 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		replyMSG.append("<td width=180><center>Character Selection Menu</center></td>");
		replyMSG.append("<td width=40><button value=\"Back\" action=\"bypass -h admin_show_characters 0\" width=40 height=15 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		replyMSG.append("</tr></table>");/*<br>*/

		replyMSG.append("<table<tr>");
		replyMSG.append("<td><button value=\"Skills\" action=\"bypass -h admin_show_skills\" width=80 height=15 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		replyMSG.append("<td><button value=\"Effects\" action=\"bypass -h admin_show_effects\" width=80 height=15 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		replyMSG.append("<td><button value=\"Actions\" action=\"bypass -h admin_character_actions\" width=80 height=15 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		replyMSG.append("</tr><tr>");
		replyMSG.append("<td><button value=\"Stats\" action=\"bypass -h admin_edit_character\" width=80 height=15 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		replyMSG.append("<td><button value=\"Exp & Sp\" action=\"bypass -h admin_add_exp_sp_to_character\" width=80 height=15 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		replyMSG.append("<td><button value=\"Reuse Skills\" action=\"bypass -h admin_remove_cooldown\" width=80 height=15 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		replyMSG.append("</tr></table>");

		replyMSG.append("<table width=270>");
		replyMSG.append("<tr><td width=100><font color=\"15C73A\">Account/IP:</font></td><td><font color=\"15C73A\">" + player.getAccountName() + "</font>/<font color=\"15C73A\">" + player.getIP() + "</font></td></tr>");
		replyMSG.append("<tr><td width=100><font color=\"318CE7\">Name/Level:</font></td><td><font color=\"318CE7\">" + player.getName() + "</font>/<font color=\"318CE7\">" + player.getLevel() + "</font></td></tr>");
		replyMSG.append("<tr><td width=100><font color=\"F4CA16\">Class/Id:</font></td><td><font color=\"F4CA16\">" + HtmlUtils.htmlClassName(player.getClassId().getId()) + "</font>/<font color=\"F4CA16\">" + player.getClassId().getId() + "</font></td></tr>");
		replyMSG.append("<tr><td width=100><font color=\"20B2AA\">Clan/Level:</font></td><td><font color=\"20B2AA\">" + clanName + "</font></td></tr>");
	...
	private void editCharacter(Player activeChar)
	{
		...
		replyMSG.append("<td width=40><button value=\"Main\" action=\"bypass -h admin_admin\" width=40 height=15 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		replyMSG.append("<td width=180><center>Character Selection Menu</center></td>");
		replyMSG.append("<td width=40><button value=\"Back\" action=\"bypass -h admin_current_player\" width=40 height=15 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		replyMSG.append("</tr></table>");
		replyMSG.append("<br><br>");
		...
		replyMSG.append("<tr><td width=50>Перерождений:</td><td><edit var=\"rebirths\" width=50></td></tr>");
		replyMSG.append("</table><br>");
		replyMSG.append("<center><button value=\"Save Changes\" action=\"bypass -h admin_save_modifications $hp & $mp & $karma & $pvpflag & $pvpkills & $classid & $rebirths &\" width=80 height=15 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></center><br>");
		replyMSG.append("</body></html>");
	...
	private ClassId getNearestClassId(Race race, boolean isMage)
	{
		ClassId validClass = null;
		...
		for(ClassId classId : ClassId.values())
		{
			...
			if(classId.isOfType(isMage ? ClassType.MYSTIC : ClassType.FIGHTER))
			{
				validClass = classId;
	...
	private void showCharacterActions(Player activeChar)
	{
		...
		replyMSG.append("<tr><td width=90><button value=\"Teleport\" action=\"bypass -h admin_teleportto " + player.getName() + "\" width=85 height=20 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		replyMSG.append("<td width=90><button value=\"Recall\" action=\"bypass -h admin_recall " + player.getName() + "\" width=85 height=20 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		replyMSG.append("<td width=90><button value=\"Quests\" action=\"bypass -h admin_quests " + player.getName() + "\" width=85 height=20 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td></tr>");
	...
	/*private void addExpSp(final Player activeChar)
	{
		...
		replyMSG.append("<td>&nbsp;<button value=\"Save Changes\" action=\"bypass -h admin_add_exp_sp exp $exp_to_add sp $sp_to_add\" width=80 height=15 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
	...
	private void addExpSp(final Player activeChar) {
		...
		replyMSG.append("<tr><td>Lv: ").append(player.getLevel()).append(" ").append(HtmlUtils.htmlClassName(player.getClassId().getId())).append("</td></tr>");
		...
		replyMSG.append("<td>Exp: <edit var=\"exp_to_add\" width=50></td>");
		replyMSG.append("<td>Sp:  <edit var=\"sp_to_add\" width=50></td>");
		replyMSG.append("<td>&nbsp;<button value=\"ADD\" action=\"bypass -h admin_add_exp_sp $exp_to_add $sp_to_add\" width=40 height=25 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		replyMSG.append("<td>&nbsp;<button value=\"MAX SP\" action=\"bypass -h admin_add_exp_sp 0 2147483647\" width=70 height=25 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		replyMSG.append("</tr></table></center>");
		replyMSG.append("<center><table><tr>");
		replyMSG.append("<td>Level: <edit var=\"level\" width=50></td>");
		replyMSG.append("<td>&nbsp;<button value=\"SET\" action=\"bypass -h admin_set_level $level\" width=40 height=25 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		replyMSG.append("<td>&nbsp;<button value=\"ADD\" action=\"bypass -h admin_add_level $level\" width=40 height=25 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		replyMSG.append("<td>&nbsp;<button value=\"MAX\" action=\"bypass -h admin_set_level ").append(Config.ALT_MAX_LEVEL).append("\" width=40 height=25 back=\"L2UI_EPIC.NewButton_Blue\" fore=\"L2UI_EPIC.NewButton_Blue\"></td>");
		replyMSG.append("</tr></table></center>");
		replyMSG.append("</body></html>");
