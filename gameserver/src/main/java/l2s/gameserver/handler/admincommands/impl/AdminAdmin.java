		...
		if(activeChar.getPlayerAccess().Menu)
		{
			...
			switch(command)
			{
				...
				case admin_debug:
					...
					_s.add("==========PvE Stats:");
					_s.add("==Phys Attack Dmg: " + pl.getStat().calc(Stats.PVE_PHYS_DMG_BONUS, 1, null, null));
					_s.add("==Phys Skill Dmg: " + pl.getStat().calc(Stats.PVE_PHYS_SKILL_DMG_BONUS, 1, null, null));
					_s.add("==Magic Skill Dmg: " + pl.getStat().calc(Stats.PVE_MAGIC_SKILL_DMG_BONUS, 1, null, null));
					_s.add("==Phys Attack Def: " + pl.getStat().calc(Stats.PVE_PHYS_DEFENCE_BONUS, 1, null, null));
					_s.add("==Phys Skill Def: " + pl.getStat().calc(Stats.PVE_PHYS_SKILL_DEFENCE_BONUS, 1, null, null));
					_s.add("==Magic Skill Def: " + pl.getStat().calc(Stats.PVE_MAGIC_SKILL_DEFENCE_BONUS, 1, null, null));
