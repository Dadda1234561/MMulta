...
public class AdminEnchant implements IAdminCommandHandler
{
	...
	public void showMainPage(Player activeChar)
	{
		...
		replyMSG.append("<td width=50><button value=\"Shirt\" action=\"bypass -h admin_setun $menu_command\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
