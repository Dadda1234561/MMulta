...
public class EffectHandlerHolder extends AbstractHolder
{
	...
	private EffectHandlerHolder()
	{
		...
		registerHandler(EffectConsumeSoulsOverTime.class);
		...
		registerHandler(EffectSkillerActive.class); // skiller attack toggler
		registerHandler(EffectHealerActive.class); // skiller heal toggler
		...
		registerHandler(i_plunder.class);
		...
		registerHandler(i_blessed_spirit_shot.class);
		registerHandler(i_blessed_summon_spirit_shot.class);
		registerHandler(i_restore_symbol_seal_points.class);
		registerHandler(i_restore_time_restrict_field.class);
		registerHandler(i_p_hit30.class);
		registerHandler(i_voice_command.class);

		// Permanent Effects
		registerHandler(p_aura.class);
		...
		registerHandler(p_dc_mode.class);
		...
		registerHandler(p_preserve_abnormal_start.class);
