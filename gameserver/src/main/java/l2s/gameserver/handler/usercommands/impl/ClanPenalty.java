...
public class ClanPenalty implements IUserCommandHandler
{
	...
	public boolean useUserCommand(int id, Player activeChar)
	{
		...
		if(activeChar.getLeaveClanTime() != 0)
			leaveClan = activeChar.getLeaveClanTime() + Config.ALT_CLAN_LEAVE_PENALTY_TIME * 60 * 60L/* * 1000L*/;

		long deleteClan = 0;
		if(activeChar.getDeleteClanTime() != 0)
			deleteClan = activeChar.getDeleteClanTime() + Config.ALT_CLAN_CREATE_PENALTY_TIME * 60 * 60L/* * 1000L*/;
