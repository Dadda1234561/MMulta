...
public class GameServer
{
	...
	public static final String PROJECT_REVISION = "L2s [45300]";
	public static final String UPDATE_NAME = "The Great Collector (306)";
	...
	public GameServer() throws Exception
	{
		...
		RebornSystemManager.load();
		RebornSubSystemManager.load();
		RebornPercentSystemManager.load();
		RebornDivineSystemManager.load();

		ItemHandler.getInstance();

		PledgeMissionHandlerHolder.getInstance();
		...
		//ChaosFestivalManager.getInstance().init(); DM
		...
		InterfaceCommandHandler.getInstance().log();
		...
		FakePlayersTable.getInstance().init();
	}
