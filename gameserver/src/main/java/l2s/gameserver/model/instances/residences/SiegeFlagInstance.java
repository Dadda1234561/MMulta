...
public class SiegeFlagInstance extends NpcInstance
{
	...
	@Override
	protected void onReduceCurrentHp(final double damage, final Creature attacker, Skill skill, final boolean awake, final boolean standUp, boolean directHp, boolean isDot, boolean isStatic)
	{
