...
public final class TamedBeastInstance extends FeedableBeastInstance
{
	...
	public void setTameType()
	{
		...
		{
			SkillEntry sk = SkillEntry.makeSkillEntry(SkillEntryType.NONE, skillId, 1);
			if(sk != null)
				_skills.add(sk);
		}
	}
	...
	public void buffOwner()
	{
		...
		{
			getMovement().setFollowTarget(getPlayer());
	...
	public static class Buff implements Runnable
	{
	...
	public void setOwner(Player owner)
	{
		...
		if(owner != null)
		{
			...
			broadcastCharInfoImpl(NpcInfoType.TITLE);
