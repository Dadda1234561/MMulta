...
public enum ClassId
{
	...
	/*135*/INSPECTOR(ClassType.FIGHTER, Race.KAMAEL, TROOPER, WARDER, ClassLevel.THIRD, ClassType2.ENCHANTER),
	...
	/*140*/TYRR_WARRIOR(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.WARRIOR, null)
	{
		@Override
		public ClassId getAwakeParent(ClassId classId)
		{
	...
	/*142*/YUL_ARCHER(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.ARCHER, null)
	{
		@Override
		public ClassId getAwakeParent(ClassId classId)
		{
	...
	/*146*/AEORE_HEALER(ClassType.MYSTIC, ClassLevel.AWAKED, ClassType2.HEALER, null)
	{
		@Override
		public ClassId getAwakeParent(ClassId classId)
		{
	...
	/*Sigel Knight*/
	/*148*/SIGEL_PHOENIX_KNIGHT(ClassType.FIGHTER, Race.HUMAN, SIGEL_KNIGHT, ClassLevel.AWAKED, ClassType2.KNIGHT)
	{
		@Override
	...
	/*149*/SIGEL_HELL_KNIGHT(ClassType.FIGHTER, Race.HUMAN, SIGEL_KNIGHT, ClassLevel.AWAKED, ClassType2.KNIGHT)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*150*/SIGEL_EVAS_TEMPLAR(ClassType.FIGHTER, Race.ELF, SIGEL_KNIGHT, ClassLevel.AWAKED, ClassType2.KNIGHT)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*151*/SIGEL_SHILLIEN_TEMPLAR(ClassType.FIGHTER, Race.DARKELF, SIGEL_KNIGHT, ClassLevel.AWAKED, ClassType2.KNIGHT)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*Tyrr Warrior*/
	/*152*/TYRR_DUELIST(ClassType.FIGHTER, Race.HUMAN, TYRR_WARRIOR, ClassLevel.AWAKED, ClassType2.WARRIOR)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*153*/TYRR_DREADNOUGHT(ClassType.FIGHTER, Race.HUMAN, TYRR_WARRIOR, ClassLevel.AWAKED, ClassType2.WARRIOR)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*154*/TYRR_TITAN(ClassType.FIGHTER, Race.ORC, TYRR_WARRIOR, ClassLevel.AWAKED, ClassType2.WARRIOR)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*155*/TYRR_GRAND_KHAVATARI(ClassType.FIGHTER, Race.ORC, TYRR_WARRIOR, ClassLevel.AWAKED, ClassType2.WARRIOR)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*156*/TYRR_MAESTRO(ClassType.FIGHTER, Race.DWARF, TYRR_WARRIOR, ClassLevel.AWAKED, ClassType2.WARRIOR)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*157*/TYRR_DOOMBRINGER(ClassType.FIGHTER, Race.KAMAEL, TYRR_WARRIOR, ClassLevel.AWAKED, ClassType2.WARRIOR)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*Othell Rogue*/
	/*158*/OTHELL_ADVENTURER(ClassType.FIGHTER, Race.HUMAN, OTHELL_ROGUE, ClassLevel.AWAKED, ClassType2.ROGUE)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*159*/OTHELL_WIND_RIDER(ClassType.FIGHTER, Race.ELF, OTHELL_ROGUE, ClassLevel.AWAKED, ClassType2.ROGUE)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*160*/OTHELL_GHOST_HUNTER(ClassType.FIGHTER, Race.DARKELF, OTHELL_ROGUE, ClassLevel.AWAKED, ClassType2.ROGUE)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*161*/OTHELL_FORTUNE_SEEKER(ClassType.FIGHTER, Race.DWARF, OTHELL_ROGUE, ClassLevel.AWAKED, ClassType2.ROGUE)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*Yul Archer*/
	/*162*/YUL_SAGITTARIUS(ClassType.FIGHTER, Race.HUMAN, YUL_ARCHER, ClassLevel.AWAKED, ClassType2.ARCHER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*163*/YUL_MOONLIGHT_SENTINEL(ClassType.FIGHTER, Race.ELF, YUL_ARCHER, ClassLevel.AWAKED, ClassType2.ARCHER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*164*/YUL_GHOST_SENTINEL(ClassType.FIGHTER, Race.DARKELF, YUL_ARCHER, ClassLevel.AWAKED, ClassType2.ARCHER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*165*/YUL_TRICKSTER(ClassType.FIGHTER, Race.KAMAEL, YUL_ARCHER, ClassLevel.AWAKED, ClassType2.ARCHER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*Feoh Wizard*/
	/*166*/FEOH_ARCHMAGE(ClassType.MYSTIC, Race.HUMAN, FEOH_WIZARD, ClassLevel.AWAKED, ClassType2.WIZARD)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*167*/FEOH_SOULTAKER(ClassType.MYSTIC, Race.HUMAN, FEOH_WIZARD, ClassLevel.AWAKED, ClassType2.WIZARD)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*168*/FEOH_MYSTIC_MUSE(ClassType.MYSTIC, Race.ELF, FEOH_WIZARD, ClassLevel.AWAKED, ClassType2.WIZARD)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*169*/FEOH_STORM_SCREAMER(ClassType.MYSTIC, Race.DARKELF, FEOH_WIZARD, ClassLevel.AWAKED, ClassType2.WIZARD)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*170*/FEOH_SOUL_HOUND(ClassType.MYSTIC, Race.KAMAEL, FEOH_WIZARD, ClassLevel.AWAKED, ClassType2.WIZARD)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*Iss Enchanter*/
	/*171*/ISS_HIEROPHANT(ClassType.MYSTIC, Race.HUMAN, ISS_ENCHANTER, ClassLevel.AWAKED, ClassType2.ENCHANTER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*172*/ISS_SWORD_MUSE(ClassType.FIGHTER, Race.ELF, ISS_ENCHANTER, ClassLevel.AWAKED, ClassType2.ENCHANTER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*173*/ISS_SPECTRAL_DANCER(ClassType.FIGHTER, Race.DARKELF, ISS_ENCHANTER, ClassLevel.AWAKED, ClassType2.ENCHANTER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*174*/ISS_DOMINATOR(ClassType.MYSTIC, Race.ORC, ISS_ENCHANTER, ClassLevel.AWAKED, ClassType2.ENCHANTER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*175*/ISS_DOOMCRYER(ClassType.MYSTIC, Race.ORC, ISS_ENCHANTER, ClassLevel.AWAKED, ClassType2.ENCHANTER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*Wynn Summoner*/
	/*176*/WYNN_ARCANA_LORD(ClassType.MYSTIC, Race.HUMAN, WYNN_SUMMONER, ClassLevel.AWAKED, ClassType2.SUMMONER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*177*/WYNN_ELEMENTAL_MASTER(ClassType.MYSTIC, Race.ELF, WYNN_SUMMONER, ClassLevel.AWAKED, ClassType2.SUMMONER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*178*/WYNN_SPECTRAL_MASTER(ClassType.MYSTIC, Race.DARKELF, WYNN_SUMMONER, ClassLevel.AWAKED, ClassType2.SUMMONER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*Aeore Healer*/
	/*179*/AEORE_CARDINAL(ClassType.MYSTIC, Race.HUMAN, AEORE_HEALER, ClassLevel.AWAKED, ClassType2.HEALER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*180*/AEORE_EVAS_SAINT(ClassType.MYSTIC, Race.ELF, AEORE_HEALER, ClassLevel.AWAKED, ClassType2.HEALER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*181*/AEORE_SHILLIEN_SAINT(ClassType.MYSTIC, Race.DARKELF, AEORE_HEALER, ClassLevel.AWAKED, ClassType2.HEALER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*183*/ERTHEIA_WIZARD(ClassType.MYSTIC, Race.ERTHEIA, null, ClassLevel.NONE, null), // Маг Артеас
	/*184*/MARAUDER(ClassType.FIGHTER, Race.ERTHEIA, ERTHEIA_FIGHTER, ClassLevel.FIRST, null), // Мародер
	/*185*/CLOUD_BREAKER(ClassType.MYSTIC, Race.ERTHEIA, ERTHEIA_WIZARD, ClassLevel.FIRST, null), // Маг Сайха
	/*186*/RIPPER(ClassType.FIGHTER, Race.ERTHEIA, MARAUDER, ClassLevel.SECOND, ClassType2.WARRIOR), // Рейнджер
	/*187*/STRATOMANCER(ClassType.MYSTIC, Race.ERTHEIA, CLOUD_BREAKER, ClassLevel.SECOND, ClassType2.WIZARD), // Маг Шторма Сайха
	/*188*/EVISCERATOR(ClassType.FIGHTER, Race.ERTHEIA, RIPPER, ClassLevel.THIRD, ClassType2.WARRIOR), // Рейнджер Гравитации
	/*189*/SAYHA_SEER(ClassType.MYSTIC, Race.ERTHEIA, STRATOMANCER, ClassLevel.THIRD, ClassType2.WIZARD), // Властитель Сайха
	...
	/*191*/UNK_210,
	/*191*/UNK_211,
	/*212*/DEATH_SOLDIER(ClassType.FIGHTER, Race.HUMAN, null, ClassLevel.NONE, null),
	/*213*/DEATH_WARRIOR(ClassType.FIGHTER, Race.HUMAN, DEATH_SOLDIER, ClassLevel.FIRST, ClassType2.KNIGHT),
	/*214*/DEATH_BERSERKER(ClassType.FIGHTER, Race.HUMAN, DEATH_WARRIOR, ClassLevel.SECOND, ClassType2.KNIGHT),
	/*215*/DEATH_KNIGHT(ClassType.FIGHTER, Race.HUMAN, DEATH_BERSERKER, ClassLevel.THIRD, ClassType2.KNIGHT),
	/*216*/SIGEL_DEATH_KNIGHT(ClassType.FIGHTER, Race.HUMAN, null, ClassLevel.AWAKED, ClassType2.KNIGHT),
	/*217*/CERT_SKILL_PROF(ClassType.FIGHTER, Race.HUMAN, null, ClassLevel.NONE, null),
	/*218*/UNK_218,
	/*219*/UNK_219,
	/*220*/UNK_220,
	/*221*/UNK_221,
	...
	/*234*/UNK_234,
	/*235*/UNK_235,
	/*236*/UNK_236(ClassType.FIGHTER, Race.HUMAN, DEATH_SOLDIER, ClassLevel.FIRST, ClassType2.KNIGHT),
	/*237*/UNK_237(ClassType.FIGHTER, Race.HUMAN, DEATH_SOLDIER, ClassLevel.FIRST, ClassType2.KNIGHT),
	/*238*/UNK_238(ClassType.FIGHTER, Race.HUMAN, DEATH_SOLDIER, ClassLevel.FIRST, ClassType2.KNIGHT),
	/*239*/UNK_239(ClassType.FIGHTER, Race.HUMAN, DEATH_SOLDIER, ClassLevel.FIRST, ClassType2.KNIGHT),
	/*240*/UNK_240(ClassType.FIGHTER, Race.HUMAN, DEATH_SOLDIER, ClassLevel.FIRST, ClassType2.KNIGHT),
	/*241*/UNK_241(ClassType.FIGHTER, Race.HUMAN, DEATH_SOLDIER, ClassLevel.FIRST, ClassType2.KNIGHT),
	/*242*/UNK_242(ClassType.FIGHTER, Race.HUMAN, DEATH_SOLDIER, ClassLevel.FIRST, ClassType2.KNIGHT),
	/*243*/UNK_243(ClassType.FIGHTER, Race.HUMAN, DEATH_SOLDIER, ClassLevel.FIRST, ClassType2.KNIGHT),
	/*244*/UNK_244(ClassType.MYSTIC, Race.ERTHEIA, ERTHEIA_FIGHTER, ClassLevel.FIRST, null),
	/*245*/UNK_245(ClassType.MYSTIC, Race.ERTHEIA, ERTHEIA_FIGHTER, ClassLevel.FIRST, null);
