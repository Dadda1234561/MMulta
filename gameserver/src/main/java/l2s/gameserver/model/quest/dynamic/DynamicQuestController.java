...
public class DynamicQuestController
{
	...
	private final class QuestStarter implements Runnable
	{
	...
	private final class QuestEnder implements Runnable
	{
		private final int questId;
	...
	private final class QuestFinalizer implements Runnable
	{
		private final int questId;
