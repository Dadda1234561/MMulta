...
public class Quest implements OnInitScriptListener
{
	...
	{
		/*{ 15642, 1 }, // Horn Melody (Adventurer)
		{ 15643, 1 }, // Drum Melody (Adventurer)
		{ 15644, 1 }, // Pipe Organ Melody (Adventurer)
		{ 15645, 1 }, // Guitar Melody (Adventurer)
		{ 15651, 1 },  // Prevailing Sonata (Adventurer)
		{ 15652, 1 },  // Daring Sonata (Adventurer)
		{ 15653, 1 },  // Refreshing Sonata (Adventurer)
		{ 32840, 1 } // Fantasia Harmony - Adventurer*/
		...
		{ 4327, 1 }, // Путешественник - Поэма Гитары
		...
		//{ 5182, 1 },  // Благословение Защиты
		{ 275, 1 },  // Путешественник - Соната Расслабления
		{ 276, 1 },  // Путешественник - Соната Расслабления
		{ 268, 1 },  // Винд
		{ 1062, 2 }  // Берсерк
	};
