...
public class CreatureBaseStats
{
	...
	{
		return getOwner().getTemplate().getBaseRaidBossDamage();
	}
	public double getSoulShotDefence()
	{
		return getOwner().getTemplate().getBaseSoulShotDefence();
	}
	public int getDamageDecreaseDif()
	{
		return getOwner().getTemplate().getBaseDamageDecreaseDif();
	}
	public double getDamageDecreasePer()
	{
		return getOwner().getTemplate().getBaseDamageDecreasePer();
	}
	public int getDifLevelForPenalty()
	{
		return getOwner().getTemplate().getBaseDifLevelForPenalty();
	}
