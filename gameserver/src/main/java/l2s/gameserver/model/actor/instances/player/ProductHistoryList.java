...
public class ProductHistoryList
{
	...
	private final TIntObjectMap<ProductHistoryItem> _productHistoryMap = new TIntObjectHashMap<ProductHistoryItem>(0);
	...
	public void restore()
	{
		if(Config.EX_USE_PRIME_SHOP)
			CharacterProductHistoryDAO.getInstance().select(_owner, _productHistoryMap);
	}
