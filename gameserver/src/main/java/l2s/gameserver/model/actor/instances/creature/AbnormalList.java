...
public final class AbnormalList implements Iterable<Abnormal>
{
	...
	private final Collection<Abnormal> _abnormals = new CopyOnWriteArrayList<>();

	private final Creature _owner;

	private final ReentrantLock _addAbnormalLock = new ReentrantLock();
	...
	public static boolean checkAbnormalType(Skill skill1, Skill skill2)
	{
		...
		if(skill1.getAbnormalType() == AbnormalType.NONE)
			return false;

		if(skill2.getAbnormalType() == AbnormalType.NONE)
			return false;

		return skill1.getAbnormalType() == skill2.getAbnormalType();
	}
