...
public class UndergroundColiseumEvent extends Event
{
	private class Timer implements Runnable
	{
		...
		public void run()
		{
			...
			{
				ExShowScreenMessage p = new ExShowScreenMessage(NpcString.THE_MATCH_IS_AUTOMATICALLY_CANCELED_BECAUSE_YOU_ARE_TOO_FAR_FROM_THE_ADMISSION_MANAGER, 5000, l2s.gameserver.network.l2.s2c.ExShowScreenMessage.ScreenMessageAlign.TOP_CENTER);
