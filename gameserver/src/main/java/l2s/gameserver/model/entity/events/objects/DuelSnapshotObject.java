...
public class DuelSnapshotObject
{
	...
	public void store()
	{
		_classIndex = _player.getActiveDualClass().getIndex();
	...
	public void restore()
	{
		...
		if(_classIndex == _player.getActiveDualClass().getIndex()) // если дуал был сменен во время дуэли бафы не восстанавливаем
		{
