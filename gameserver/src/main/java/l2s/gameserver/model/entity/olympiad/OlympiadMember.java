...
public class OlympiadMember
{
	...
	private double _sumDamage; // Нанесенный урон, складывается на протяжении 3х раундов
	...
	public boolean checkPlayer()
	{
		...
		if(player == null || player.isLogoutStarted() || player.getOlympiadGame() == null || player.isInObserverMode())
			return false;
		if(player.isCursedWeaponEquipped())// TODO: Найти подходящее место.
			return false;
		return true;
	}
	...
	public void addSumDamage(double d){
		_sumDamage += d;
	}
