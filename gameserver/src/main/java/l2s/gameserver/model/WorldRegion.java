...
//	private volatile GameObject[] _objects = GameObject.EMPTY_L2OBJECT_ARRAY;
	private final CopyOnWriteArrayList<GameObject> _objects = new CopyOnWriteArrayList<>();
	private final CopyOnWriteArrayList<Zone> _zones = new CopyOnWriteArrayList<>();
