...
public class i_hp_drain extends i_abstract_effect
{
	...
	public void instantUse(Creature effector, Creature effected, boolean reflected)
	{
		...
		if(getSkill().isMagic())
		{
			...
			realTarget.reduceCurrentHp(info.damage, effector, getSkill(), true, true, false, true, false, false, true, true, info.crit, info.miss, info.shld, false);
			if(info.damage >= 1)
			{
		...
		else
		{
			...
			if(info != null)
			{
				realTarget.reduceCurrentHp(info.damage, effector, getSkill(), true, true, false, true, false, false, true, true, info.crit || info.blow, info.miss, info.shld, false);
