...
public class EffectNegateMark extends EffectHandler
{
	...
	private static final int MARK_OF_WEAKNESS_NOVICE = 30656;
	private static final int MARK_OF_PLAGUE_NOVICE = 30755;
	private static final int MARK_OF_TRICK_NOVICE = 30756;
	...
	public void onStart(Abnormal abnormal, Creature effector, Creature effected)
	{
		...
		for(Abnormal a : effected.getAbnormalList())
		{
			...
			if(skillId == MARK_OF_WEAKNESS || skillId == MARK_OF_PLAGUE || skillId == MARK_OF_TRICK || skillId == MARK_OF_WEAKNESS_NOVICE || skillId == MARK_OF_PLAGUE_NOVICE || skillId == MARK_OF_TRICK_NOVICE)
			{
		...
		if(markCount > 0)
		{
			...
			effected.reduceCurrentHp(info.damage * markCount, effector, skill, true, true, false, true, false, false, true, true, info.crit, info.miss, info.shld, false);
		}
	}
}
