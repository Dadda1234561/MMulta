...
public class i_death_link extends i_abstract_effect
{
	...
	public void instantUse(Creature effector, Creature effected, boolean reflected)
	{
		...
		realTarget.reduceCurrentHp(info.damage, effector, getSkill(), true, true, false, true, false, false, getTemplate().isInstant(), getTemplate().isInstant(), info.crit, info.miss, info.shld, false);
		if(info.damage >= 1)
		{
