...
public class PDam extends Skill
{
	...
	public PDam(StatsSet set)
	{
		...
		_isForPlayer = set.getBool("damageForPlayerOnly", false);
	}
	...
	protected void useSkill(Creature activeChar, Creature target, boolean reflected)
	{
		...
		if (_static && _isForPlayer && !target.isPlayable())
		{
			return;
		}
		if(_static)
		{
			realTarget.reduceCurrentHp(power, activeChar, this, true, true, _directHp, true, false, false, power != 0, true, false, false, false, true);
			return;
		}
