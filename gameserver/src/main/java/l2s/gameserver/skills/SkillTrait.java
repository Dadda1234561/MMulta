...
public enum SkillTrait
{
	...
	/*1*/SWORD(SkillTraitType.WEAPON, Stats.ATTACK_TRAIT_SWORD, Stats.DEFENCE_TRAIT_SWORD)
	{
		...
		public double getAttackMod() {
			return Config.USE_CUSTOM_ATTACK_TRAITS ? Config.ATTACK_TRAIT_WEAPON_MOD : super.getAttackMod();
		}

		@Override
		public double getDefenceMod() {
			return Config.USE_CUSTOM_DEFENCE_TRAITS ? Config.DEFENCE_TRAIT_WEAPON_MOD : super.getDefenceMod();
		}
	},
