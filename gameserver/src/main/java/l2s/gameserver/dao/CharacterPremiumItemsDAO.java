...
public class CharacterPremiumItemsDAO
{
	...
	public boolean insert(Player owner, PremiumItem item)
	{
		...
		{
			_log.warn(owner.getPremiumItemList() + " could not add item to premium item list: " + item, e);
			return false;
		}
		finally
		{
	...
	public boolean delete(Player owner, PremiumItem item)
	{
		...
		{
			_log.warn(owner.getPremiumItemList() + " could not delete item: " + item + " ownerId: " + owner.getObjectId(), e);
			return false;
		}
		finally
		{
	...
	public boolean update(Player owner, PremiumItem item, long count)
	{
		...
		{
			_log.warn(owner.getPremiumItemList() + " could not update item: " + item, e);
			return false;
		}
		finally
		{
