...
public class CharacterDAO
{
	...
	public boolean insert(Player player)
	{
		...
		try
		{
			...
			statement.setInt(25, player.getNobleType().ordinal());
			statement.setInt(26, player.getUsedWorldChatPoints());
			statement.setInt(27, player.hideHeadAccessories() ? 1 : 0);
			statement.setInt(28, player.getRebirthCount());
