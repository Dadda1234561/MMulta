...
public class CharacterAI extends AbstractAI
{
	...
	private boolean _patroller = false;
	...
	public void setPatroller(boolean val){
		_patroller = val;
	}
	...
	protected void onEvtDead(Creature killer)
	{
		...
		actor.sendPacket(new ExDieInfo(actor));
		if (actor.isPlayer())
		{
			actor.startAbnormalEffect(AbnormalEffect.DEATH_EFFECT_AVE);
			actor.sendPacket(new SystemMessagePacket(SystemMsg.S1S_EFFECT_CAN_BE_FELT).addSkillName(32935, 1));
		}
