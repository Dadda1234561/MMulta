...
public class RequestRestart extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(activeChar.isBlocked() && !activeChar.isInTrainingCamp() && !activeChar.isFlying() && !activeChar.isInAwayingMode() && !activeChar.isInFlyMove()) // Разрешаем выходить из игры если используется сервис HireWyvern. Вернет в начальную точку.
		{
