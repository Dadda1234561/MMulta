...
public class MyPetSummonInfoPacket extends L2GameServerPacket
{
	...
	private int _type, obj_id, npc_id, _sp, level;
	private int curFed, maxFed, curHp, maxHp, curMp, maxMp, curLoad, maxLoad;
	private int MAtk, MDef, sps, ss, type, _showSpawnAnimation;
	private long PAtk, PDef;
	...
	public MyPetSummonInfoPacket(Servitor summon)
	{
		...
		PAtk = (int) summon.getPAtk(null);
		PDef = summon.getPDef(null);
		MAtk = (int) summon.getMAtk(null, null);
	...
	protected final void writeImpl()
	{
		...
		writeD((int) PAtk);//patk
		writeD((int) PDef);//pdef
