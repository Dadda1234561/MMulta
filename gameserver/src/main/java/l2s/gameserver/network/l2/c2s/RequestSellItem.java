	...
	protected void runImpl()
	{
		...
		try
		{
			for(int i = 0; i < _count; i++)
			{
				...
				totalPrice = SafeMath.addAndCheck(totalPrice, Config.ALT_SELL_ITEM_ONE_ADENA ? 1 : SafeMath.mulAndCheck(item.getReferencePrice(), count) / Config.SELL_ITEM_COUNT_PRICE);
