...
public enum ServerPacketOpcodes
{
	...
	/*0xFE:0x101*/	ExNotUsed257,
	/*0xFE:0x102*/	ExNotUsed258,
	/*0xFE:0x103*/	ExNotUsed259,
	...
	/*0xFE:0x208*/  ExClassChangeSetAlarm,   // S_EX_CLASS_CHANGE_SET_ALARM,
	/*0xFE:0x209*/  ExRequestClassChange,   // S_EX_REQUEST_CLASS_CHANGE,
	/*0xFE:0x20A*/  ExRequestClassChangeVerifying,   // S_EX_REQUEST_CLASS_CHANGE_VERIFYING,
	...
	/*0xFE:0x281*/  ExRankingFestivalSidebarInfo, // EX_RANKING_FESTIVAL_SIDEBAR_INFO
	/*0xFE:0x282*/  ExRankingFestivalBuy, // EX_RANKING_FESTIVAL_BUY
	/*0xFE:0x283*/  ExRankingFestivalBonus, // EX_RANKING_FESTIVAL_BONUS
	/*0xFE:0x284*/  ExRankingFestivalRanking, // EX_RANKING_FESTIVAL_RANKING
	/*0xFE:0x285*/  ExRankingFestivalMyinfo, // EX_RANKING_FESTIVAL_MYINFO
	/*0xFE:0x286*/  ExRankingFestivalMyReceivedBonus, // EX_RANKING_FESTIVAL_MY_RECEIVED_BONUS
	/*0xFE:0x287*/  ExRankingFestivalReward, // EX_RANKING_FESTIVAL_REWARD
	/*0xFE:0x288*/  ExTimerCheck, // EX_TIMER_CHECK
	/*0xFE:0x289*/  ExSteadyBoxUiInit, // EX_STEADY_BOX_UI_INIT
	/*0xFE:0x28A*/  ExSteadyAllBoxUpdate, // EX_STEADY_ALL_BOX_UPDATE
	/*0xFE:0x28B*/  ExSteadyOneBoxUpdate, // EX_STEADY_ONE_BOX_UPDATE
	/*0xFE:0x28C*/  ExSteadyBoxReward, // EX_STEADY_BOX_REWARD
	/*0xFE:0x28D*/  ExPetRankingMyInfo, // EX_PET_RANKING_MY_INFO
	/*0xFE:0x28E*/  ExPetRankingList, // EX_PET_RANKING_LIST
	/*0xFE:0x28F*/  ExCollectionInfo, // EX_COLLECTION_INFO
	/*0xFE:0x290*/  ExCollectionOpenUI, // EX_COLLECTION_OPEN_UI
	/*0xFE:0x291*/  ExCollectionCloseUI, // EX_COLLECTION_CLOSE_UI
	/*0xFE:0x292*/  ExCollectionList, // EX_COLLECTION_LIST
	/*0xFE:0x293*/  ExCollectionUpdateFavorite, // EX_COLLECTION_UPDATE_FAVORITE
	/*0xFE:0x294*/  ExCollectionFavoriteList, // EX_COLLECTION_FAVORITE_LIST
	/*0xFE:0x295*/  ExCollectionSummary, // EX_COLLECTION_SUMMARY
	/*0xFE:0x296*/  ExCollectionRegister, // EX_COLLECTION_REGISTER
	/*0xFE:0x297*/  ExCollectionComplete, // EX_COLLECTION_COMPLETE
	/*0xFE:0x298*/  ExCollectionReceiveReward, // EX_COLLECTION_RECEIVE_REWARD
	/*0xFE:0x299*/  ExCollectionReset, // EX_COLLECTION_RESET
	/*0xFE:0x29A*/  ExCollectionActiveEvent, // EX_COLLECTION_ACTIVE_EVENT
	/*0xFE:0x29B*/  ExCollectionResetReward, // EX_COLLECTION_RESET_REWARD
	/*0xFE:0x29C*/  ExPvpbookShareRevengeList, // EX_PVPBOOK_SHARE_REVENGE_LIST
	/*0xFE:0x29D*/  ExPvpbookShareRevengeKillerLocation, // EX_PVPBOOK_SHARE_REVENGE_KILLER_LOCATION
	/*0xFE:0x29E*/  ExPvpbookShareRevengeNewRevengeinfo, // EX_PVPBOOK_SHARE_REVENGE_NEW_REVENGEINFO
	/*0xFE:0x29F*/  ExPenaltyItemDrop, // EX_PENALTY_ITEM_DROP
	/*0xFE:0x2A0*/  ExPenaltyItemList, // EX_PENALTY_ITEM_LIST
	/*0xFE:0x2A1*/  ExPenaltyItemRestore, // EX_PENALTY_ITEM_RESTORE
	/*0xFE:0x2A2*/  ExUserWatcherTargetList, // EX_USER_WATCHER_TARGET_LIST
	/*0xFE:0x2A3*/  ExUserWatcherTargetStatus, // EX_USER_WATCHER_TARGET_STATUS
	/*0xFE:0x2A4*/  ExHomunculusActivateSlotResult, // EX_HOMUNCULUS_ACTIVATE_SLOT_RESULT
	/*0xFE:0x2A5*/  ExShowHomunculusCouponUi, // EX_SHOW_HOMUNCULUS_COUPON_UI
	/*0xFE:0x2A6*/  ExSummonHomunculusCouponResult, // EX_SUMMON_HOMUNCULUS_COUPON_RESULT
	/*0xFE:0x2A7*/  ExPenaltyItemInfo, // EX_PENALTY_ITEM_INFO
	/*0xFE:0x2A8*/  ExMagicSkillUseGround, // EX_MAGIC_SKILL_USE_GROUND
	/*0xFE:0x2A9*/  ExSubjugationSidebar, // EX_SUBJUGATION_SIDEBAR
	/*0xFE:0x2AA*/  ExSubjugationList, // EX_SUBJUGATION_LIST
	/*0xFE:0x2AB*/  ExSubjugationRanking, // EX_SUBJUGATION_RANKING
	/*0xFE:0x2AC*/  ExSubjugationGachaUi, // EX_SUBJUGATION_GACHA_UI
	/*0xFE:0x2AD*/  ExSubjugationGacha, // EX_SUBJUGATION_GACHA
	/*0xFE:0x2AE*/  ExUserViewInfoParameter, // EX_USER_VIEW_INFO_PARAMETER
	/*0xFE:0x2AF*/  ExPledgeDonationInfo, // EX_PLEDGE_DONATION_INFO
	/*0xFE:0x2B0*/  ExPledgeDonationRequest, // EX_PLEDGE_DONATION_REQUEST
	/*0xFE:0x2B1*/  ExPledgeContributionList, // EX_PLEDGE_CONTRIBUTION_LIST
	/*0xFE:0x2B2*/  ExPledgeRankingMyInfo, // EX_PLEDGE_RANKING_MY_INFO
	/*0xFE:0x2B3*/  ExPledgeRankingList, // EX_PLEDGE_RANKING_LIST
	/*0xFE:0x2B4*/  ExItemRestoreList, // EX_ITEM_RESTORE_LIST
	/*0xFE:0x2B5*/  ExItemRestore, // EX_ITEM_RESTORE
	/*0xFE:0x2B6*/  ExPledgeCoinInfo, // EX_PLEDGE_COIN_INFO
	/*0xFE:0x2B7*/  ExDethroneInfo, // EX_DETHRONE_INFO
	/*0xFE:0x2B8*/  ExDethroneRankingInfo, // EX_DETHRONE_RANKING_INFO
	/*0xFE:0x2B9*/  ExDethroneServerInfo, // EX_DETHRONE_SERVER_INFO
	/*0xFE:0x2BA*/  ExDethroneDistrictOccupationInfo, // EX_DETHRONE_DISTRICT_OCCUPATION_INFO
	/*0xFE:0x2BB*/  ExDethroneDailyMissionInfo, // EX_DETHRONE_DAILY_MISSION_INFO
	/*0xFE:0x2BC*/  ExDethroneDailyMissionGetReward, // EX_DETHRONE_DAILY_MISSION_GET_REWARD
	/*0xFE:0x2BD*/  ExDethroneDailyMissionComplete, // EX_DETHRONE_DAILY_MISSION_COMPLETE
	/*0xFE:0x2BE*/  ExDethronePrevSeasonInfo, // EX_DETHRONE_PREV_SEASON_INFO
	/*0xFE:0x2BF*/  ExDethroneGetReward, // EX_DETHRONE_GET_REWARD
	/*0xFE:0x2C0*/  ExDethroneCheckName, // EX_DETHRONE_CHECK_NAME
	/*0xFE:0x2C1*/  ExDethroneChangeName, // EX_DETHRONE_CHANGE_NAME
	/*0xFE:0x2C2*/  ExDethroneConnectCastle, // EX_DETHRONE_CONNECT_CASTLE
	/*0xFE:0x2C3*/  ExDethroneDisconnectCastle, // EX_DETHRONE_DISCONNECT_CASTLE
	/*0xFE:0x2C4*/  ExDethroneSeasonInfo, // EX_DETHRONE_SEASON_INFO
	/*0xFE:0x2C5*/  ExServerlimitItemAnnounce, // EX_SERVERLIMIT_ITEM_ANNOUNCE
	...
	/*0xFE:0x2CB*/  ExWorldcastlewarCastleSiegeAttackerList, // EX_WORLDCASTLEWAR_CASTLE_SIEGE_ATTACKER_LIST
	/*0xFE:0x2CC*/  ExWorldcastlewarPledgeMercenaryMemberList, // EX_WORLDCASTLEWAR_PLEDGE_MERCENARY_MEMBER_LIST
	/*0xFE:0x2CD*/  ExWorldcastlewarPledgeMercenaryMemberJoin, // EX_WORLDCASTLEWAR_PLEDGE_MERCENARY_MEMBER_JOIN
	/*0xFE:0x2CE*/  ExWorldcastlewarSiegeMainbattleOccupyInfo, // EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_OCCUPY_INFO
	/*0xFE:0x2CF*/  ExWorldcastlewarSiegeMainbattleHeroWeaponInfo, // EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_HERO_WEAPON_INFO
	/*0xFE:0x2D0*/  ExWorldcastlewarSiegeMainbattleHeroWeaponUser, // EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_HERO_WEAPON_USER
	/*0xFE:0x2D1*/  ExWorldcastlewarSiegeMainbattleSiegeGolemInfo, // EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_SIEGE_GOLEM_INFO
	/*0xFE:0x2D2*/  ExWorldcastlewarSiegeMainbattleDoorInfo, // EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_DOOR_INFO
	/*0xFE:0x2D3*/  ExWorldcastlewarSiegeMainbattleHudInfo, // EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_HUD_INFO
	...
	/*0xFE:0x2D7*/  ExNewHennaList, // EX_NEW_HENNA_LIST
	/*0xFE:0x2D8*/  ExNewHennaEquip, // EX_NEW_HENNA_EQUIP
	/*0xFE:0x2D9*/  ExNewHennaUnequip, // EX_NEW_HENNA_UNEQUIP
	/*0xFE:0x2DA*/  ExNewHennaPotenSelect, // EX_NEW_HENNA_POTEN_SELECT
	/*0xFE:0x2DB*/  ExNewHennaPotenEnchant, // EX_NEW_HENNA_POTEN_ENCHANT
	/*0xFE:0x2DC*/  ExNewHennaCompose, // EX_NEW_HENNA_COMPOSE
	/*0xFE:0x2DD*/  ExRequestInviteParty, // EX_REQUEST_INVITE_PARTY
	/*0xFE:0x2DE*/  ExInitGlobalEventUi, // EX_INIT_GLOBAL_EVENT_UI
	/*0xFE:0x2DF*/  ExShowGlobalEventUi, // EX_SHOW_GLOBAL_EVENT_UI
	/*0xFE:0x2E0*/  ExL2passSimpleInfo, // EX_L2PASS_SIMPLE_INFO
	/*0xFE:0x2E1*/  ExL2passInfo, // EX_L2PASS_INFO
	/*0xFE:0x2E2*/  ExSayhasSupportInfo, // EX_SAYHAS_SUPPORT_INFO
	/*0xFE:0x2E3*/  ExResetEnchantItemFailRewardInfo, // EX_RES_ENCHANT_ITEM_FAIL_REWARD_INFO
	/*0xFE:0x2E4*/  ExChangedEnchantTargetItemProbabilityList, // EX_CHANGED_ENCHANT_TARGET_ITEM_PROB_LIST
	/*0xFE:0x2E5*/  ExEnchantChallengePointInfo, // EX_ENCHANT_CHALLENGE_POINT_INFO
	/*0xFE:0x2E6*/  ExSetEnchantChallengePoint, // EX_SET_ENCHANT_CHALLENGE_POINT
	/*0xFE:0x2E7*/  ExResetEnchantChallengePoint, // EX_RESET_ENCHANT_CHALLENGE_POINT
	/*0xFE:0x2E8*/  ExResetSelectMultiEnchantScroll, // EX_RES_SELECT_MULTI_ENCHANT_SCROLL
	/*0xFE:0x2E9*/  ExResultSetMultiEnchantItemList, // EX_RES_SET_MULTI_ENCHANT_ITEM_LIST
	/*0xFE:0x2EA*/  ExResultMultiEnchantItemList, // EX_RES_MULTI_ENCHANT_ITEM_LIST
	/*0xFE:0x2EB*/  ExWorldcastlewarHostSupportPledgeRankingInfo, // EX_WORLDCASTLEWAR_HOST_SUPPORT_PLEDGE_RANKING_INFO
	/*0xFE:0x2EC*/  ExWorldcastlewarHostPledgeRankingInfo, // EX_WORLDCASTLEWAR_HOST_PLEDGE_RANKING_INFO
	/*0xFE:0x2ED*/  ExWorldcastlewarHostPersonalRankingInfo, // EX_WORLDCASTLEWAR_HOST_PERSONAL_RANKING_INFO
	/*0xFE:0x2EE*/  ExWorldcastlewarSupportPledgeRankingInfo, // EX_WORLDCASTLEWAR_SUPPORT_PLEDGE_RANKING_INFO
	/*0xFE:0x2EF*/  ExWorldcastlewarPledgeRankingInfo, // EX_WORLDCASTLEWAR_PLEDGE_RANKING_INFO
	/*0xFE:0x2F0*/  ExWorldcastlewarPersonalRankingInfo, // EX_WORLDCASTLEWAR_PERSONAL_RANKING_INFO
	/*0xFE:0x2F1*/  ExHomunculusCreateProbList, // EX_HOMUNCULUS_CREATE_PROB_LIST
	/*0xFE:0x2F2*/  ExHomunculusCouponProbList, // EX_HOMUNCULUS_COUPON_PROB_LIST
	/*0xFE:0x2F3*/  ExWorldcastlewarHostCastleSiegeRankingInfo, // EX_WORLDCASTLEWAR_HOST_CASTLE_SIEGE_RANKING_INFO
	/*0xFE:0x2F4*/  ExWorldcastlewarCastleSiegeRankingInfo, // EX_WORLDCASTLEWAR_CASTLE_SIEGE_RANKING_INFO
	/*0xFE:0x2F5*/  ExMissionLevelRewardList, // EX_MISSION_LEVEL_REWARD_LIST
	/*0xFE:0x2F6*/  ExBalrogwarShowUi, // EX_BALROGWAR_SHOW_UIExBalrogwarShowUi
	/*0xFE:0x2F7*/  ExBalrogwarShowRanking, // EX_BALROGWAR_SHOW_RANKING
	/*0xFE:0x2F8*/  ExBalrogwarGetReward, // EX_BALROGWAR_GET_REWARD
	/*0xFE:0x2F9*/  ExBalrogwarHud, // EX_BALROGWAR_HUD
	/*0xFE:0x2FA*/  ExBalrogwarBossinfo, // EX_BALROGWAR_BOSSINFO
	/*0xFE:0x2FB*/  ExUserRestartLockerList, // EX_USER_RESTART_LOCKER_LIST
	/*0xFE:0x2FC*/  ExUserRestartLockerUpdate, // EX_USER_RESTART_LOCKER_UPDATE
	/*0xFE:0x2FD*/  ExWorldExchangeItemList, // EX_WORLD_EXCHANGE_ITEM_LIST
	/*0xFE:0x2FE*/  ExWorldExchangeRegiItem, // EX_WORLD_EXCHANGE_REGI_ITEM
	/*0xFE:0x2FF*/  ExWorldExchangeBuyItem, // EX_WORLD_EXCHANGE_BUY_ITEM
	/*0xFE:0x300*/  ExWorldExchangeSettleList, // EX_WORLD_EXCHANGE_SETTLE_LIST
	/*0xFE:0x301*/  ExWorldExchangeSettleRecvResult, // EX_WORLD_EXCHANGE_SETTLE_RECV_RESULT
	/*0xFE:0x302*/  ExWorldExchangeSellCompleteAlarm, // EX_WORLD_EXCHANGE_SELL_COMPLETE_ALARM
	/*0xFE:0x303*/  ExReadyItemAutoPeel, // EX_READY_ITEM_AUTO_PEEL
	/*0xFE:0x304*/  ExResultItemAutoPeel, // EX_RESULT_ITEM_AUTO_PEEL
	/*0xFE:0x305*/  ExStopItemAutoPeel, // EX_STOP_ITEM_AUTO_PEEL
	/*0xFE:0x306*/  ExTimeRestrictFieldDieLimtTime, // EX_TIME_RESTRICT_FIELD_DIE_LIMT_TIME
	/*0xFE:0x307*/  ExApplyVariationOption, // EX_APPLY_VARIATION_OPTION
	ExRequestAudioLogSave, // EX_REQUEST_AUDIO_LOG_SAVE
	ExBrVersion, // EX_BR_VERSION
	//// 388
	ExNotifyAttendance,//EX_NOTIFY_ATTENDANCE(0xFE, 0x30A),
	ExWrankingFestivalInfo,//EX_WRANKING_FESTIVAL_INFO(0xFE, 0x30B),
	ExWrankingFestivalSidebarInfo,//EX_WRANKING_FESTIVAL_SIDEBAR_INFO(0xFE, 0x30C),
	ExWrankingFestivalBu, //EX_WRANKING_FESTIVAL_BU(0xFE, 0x30D),
	ExWrankingFestivalBonus,//EX_WRANKING_FESTIVAL_BONUS(0xFE, 0x30E),
	ExWrankingFestivalRanking,//EX_WRANKING_FESTIVAL_RANKING(0xFE, 0x30F),
	ExWrankingFestivalMyInfo,//EX_WRANKING_FESTIVAL_MYINFO(0xFE, 0x310),
	ExWrankingFestivalMyReceivedBonus,//EX_WRANKING_FESTIVAL_MY_RECEIVED_BONUS(0xFE, 0x311),
	ExWrankingFestivalReward,//EX_WRANKING_FESTIVAL_REWARD(0xFE, 0x312),
	ExTooltipParam,//EX_TOOLTIP_PARAM(0xFE, 0x313),
	ExReceivedPostList,//EX_RECEIVED_POST_LIST(0xFE, 0x314),
	ExTimeRestrictFieldEntedInfo,//EX_TIME_RESTRICT_FIELD_ENTER_INFO(0xFE, 0x315),
	ExTimeRestrictFieldServerGroup,//EX_TIME_RESTRICT_FIELD_SERVER_GROUP(0xFE, 0x316),
	ExWorldExchangeSettleAlarm,//EX_WORLD_EXCHANGE_SETTLE_ALARM(0xFE, 0x317),
	ExHeroBookInfo,//EX_HERO_BOOK_INFO(0xFE, 0x318),
	ExHeroBookShowUI,//EX_HERO_BOOK_UI(0xFE, 0x319),
	ExHeroBookCharge,//EX_HERO_BOOK_CHARGE(0xFE, 0x31A),
	ExHeroBookEnchant,//EX_HERO_BOOK_ENCHANT(0xFE, 0x31B),
	ExTeleportUi,//EX_TELEPORT_UI(0xFE, 0x31C),
	ExGoodsGiftChangedNotification,//EX_GOODS_GIFT_CHANGED_NOTIFICATION(0xFE, 0x31D),
	ExGoodGiftListInfo,//EX_GOODS_GIFT_LIST_INFO(0xFE, 0x31E),
	ExGoodsGiftAcceptResul,//EX_GOODS_GIFT_ACCEPT_RESULT(0xFE, 0x31F),
	ExGoodsGiftRefuseResult,//EX_GOODS_GIFT_REFUSE_RESULT(0xFE, 0x320),
	ExNonpvpserverNotifyActivateflag,//EX_NONPVPSERVER_NOTIFY_ACTIVATEFLAG(0xFE, 0x321),
	ExWorldExchangeAveragePrice,//EX_WORLD_EXCHANGE_AVERAGE_PRICE(0xFE, 0x322),
	ExWorldExchangeTotalList,//EX_WORLD_EXCHANGE_TOTAL_LIST(0xFE, 0x323),
	ExPrisonUserEnter,//EX_PRISON_USER_ENTER(0xFE, 0x324),
	ExPrisonUserExit,//EX_PRISON_USER_EXIT(0xFE, 0x325),
	ExPrisonUserInfo,//EX_PRISON_USER_INFO(0xFE, 0x326),
	ExPrisonDonation,//EX_PRISON_USER_DONATION(0xFE, 0x327),
	ExItemRestoreOpen,//EX_ITEM_RESTORE_OPEN(0xFE, 0x328),
	ExItemScore(0xFE, 0x1E5),
	ExMax; // S_EX_MAX
	...
	private ServerPacketOpcodes(int opcode1, int opcode2)
	{
		_id = opcode1;
		_exId = opcode2;
	}
