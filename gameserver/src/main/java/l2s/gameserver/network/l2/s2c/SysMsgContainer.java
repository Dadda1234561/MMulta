...
public abstract class SysMsgContainer<T extends SysMsgContainer<T>> extends L2GameServerPacket
{
	...
	public T addFactionName(FactionType i)
	{
		return add(new FactionNameArgument(i.ordinal()));
	}
	...
	public static class SkillArgument extends IArgument
	{
		...
		void writeData(SysMsgContainer<?> message)
		{
			...
			message.writeH(SkillUtils.getSkillLevelFromMask(_skillLevel));
			message.writeH(SkillUtils.getSubSkillLevelFromMask(_skillLevel));
		}
