...
public class ShowBoardPacket extends L2GameServerPacket
{
	...
	public static void separateAndSend(String html, Player player)
	{
		...
		html = html.replace("<?total_online?>", String.valueOf((int) (((GameObjectsStorage.getPlayers(true, true).size() + FakePlayersTable.getActiveFakePlayersCount())) * Config.ONLINE_PLAYER_COUNT_MULTIPLIER)));
