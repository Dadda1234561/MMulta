...
public class ExResultMultiEnchantItemList extends L2GameServerPacket
{
    ...
    {
        return ServerPacketOpcodes.ExResultMultiEnchantItemList;
    }

    @Override
    protected final void writeImpl()
    {
       ExResultMultiEnchantItemList.this.getOpcodes();
        ...
        if (((_successEnchant.size() == 0) && (_player.getMultiFailItemsCount() != 0))
                || (_isResult && (_player.getMultiFailItemsCount() != 0)))
        {
