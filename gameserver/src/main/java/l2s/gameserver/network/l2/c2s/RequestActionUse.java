...
public class RequestActionUse extends L2GameClientPacket
{
	...
	public static enum Action
	{
		...
		ACTION1144(1144, 5, 11375),	// Атакующий Прыжок Коммандо
		ACTION1145(1145, 5, 11376),	// Двойное Сокрушение Коммандо
		ACTION1146(1146, 5, 11378),	// Стихийное Сокрушение
		ACTION1147(1147, 5, 11377),	// Мощь Кошки Колдуньи
		ACTION1148(1148, 5, 11379),	// Стремительный Бросок Лансера
		ACTION1149(1149, 5, 11380),	// Клеймо Силы
		ACTION1150(1150, 5, 11382),	// Массовая Заморозка
		ACTION1151(1151, 5, 11381),	// Мощь Херувима
		ACTION1152(1152, 5, 11383),	// Призрачный Удар Меча
		ACTION1153(1153, 5, 11384),	// Призрачный Импульс
		ACTION1154(1154, 5, 120266),	// Притягивание Фантома
		ACTION1155(1155, 5, 120268),	// Проклятие Фантома
			...
			switch(action.id)
			{
				...
				case 38: // Mount
				{
					...
					else if(pet == null || !pet.isMountable())
					{
						...
						activeChar.sendPacket(SystemMsg.YOU_CANNOT_BOARD_BECAUSE_YOU_DO_NOT_MEET_THE_REQUIREMENTS);
					else if(activeChar.isFishing() || activeChar.isInTrainingCamp())
						activeChar.sendPacket(SystemMsg.YOU_CANNOT_BOARD_BECAUSE_YOU_DO_NOT_MEET_THE_REQUIREMENTS);
				...
				case 67: // Steer. Allows you to control the Airship.
					if(activeChar.isInBoat() && activeChar.getBoat().isClanAirShip() && !activeChar.getBoat().getMovement().isMoving())
					{
