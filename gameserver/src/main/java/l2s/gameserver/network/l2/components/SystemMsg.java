...
public enum SystemMsg implements IBroadcastPacket
{
	...
	// Message: You are no longer $s1's mentee, as you have achieved Lv. 105. You do not need a mentor any longer.
	YOU_ARE_NO_LONGER_S1_S_MENTEE_AS_YOU_HAVE_ACHIEVED_LV_105_YOU_DO_NOT_NEED_A_MENTOR_ANY_LONGER(3706),
	...
	// Message: $s1 Is Lv. 105 or higher and cannot become a mentee.
	S1_IS_LV_105_OR_HIGHER_AND_CANNOT_BECOME_A_MENTEE(3703),
	// Message: $s1 does not have the item needed to become a mentee.
	S1_DOES_NOT_HAVE_THE_ITEM_NEDEED_TO_BECOME_A_MENTEE(3704),
	// Message: $s1 has achieved Lv. 105 and the mentor-mentee relationship has ended. You will be able to become another character`s mentor after one day.
	S1_HAS_ACHIEVED_LV_105_AND_THE_MENTORMENTEE_RELATIONSHIP_HAS_ENDED_YOU_WILL_BE_ABLE_TO_BECOME_ANOTHER_CHARACTERS_MENTOR_AFTER_ONE_DAY(3705),
	...
	THE_PRODUCT_INVENTORY_CANNOT_BE_USED_DURING_TRADING_PRIVATE_STORE_AND_WORKSHOP_SETUP_(3413),
	...
	// Message: You've obtained $s1. You can obtain up to $s2 of these items a day. You can get more after 06:30 AM every day.
	YOU_RECEIVED_ITEM_S1_THIS_ITEM_IS_AVAILABLE_IN_THE_AMOUNT_S2_OF_PCS_IN_A_DAY_THE_RECEIPT_ACCOUNT_IS_RESET_AT_0630_EVERY_DAY(3851),
	...
	OLYMPIAD_START(5185),
	OLYMPIAD_VICTORY(5186),
	OLYMPIAD_DEFEAT(5187),
	OLYMPIAD_TIE(5188),
	OLYMPIAD_TIME_OUT(5189),
	OLYMPIAD_ROLLOVER(5190), // K O
	OLYMPIAD_ROUND_1(5191),
	OLYMPIAD_ROUND_2(5192),
	OLYMPIAD_ROUND_3(5193),
	// Message: Artifact upgrade succeeded and you obtained $s1.
	ARTIFACT_UPGRADE_SUCCEEDED_AND_YOU_OBTAINED_S1(5208),
	// Message: Failed to upgrade Artifact. The item's upgrade level will remain the same.
	FAILED_TO_UPGRADE_ARTIFACT_THE_ITEMS_UPGRADE_LEVEL_WILL_REMAIN_THE_SAME(5209),
	// Message: You are already equipping the same Artifact.
	YOU_ARE_ALREADY_EQUIPPING_THE_SAME_ARTIFACT(5210),
	// Message: You haven't equipped an Artifact Book, so $s1 cannot be equipped.
	YOU_HAVENT_EQUIPPED_AN_ARTIFACT_BOOK_SO_S1_CANNOT_BE_EQUIPPED(5211),
	...
	// Message: You can enter the area only from Peace Zone.
	YOU_CAN_ENTER_THE_AREA_ONLY_FROM_PEACE_ZONE(13007),
	...
	// Message: Special instance zones cannot be used while waiting for the Ceremony of Chaos.
	SPECIAL_INSTANCE_ZONES_CANNOT_BE_USED_WHILE_WAITING_FOR_THE_CEREMONY_OF_CHAOS(13020),
	...
	//Message: Кол-во Перерождений не соответствует условию зоны.
	COUNT_REBIRTHS_NOT_CORRESPOND_THE_ZONE_CONDITION(15000),
	// Message: Battle with Balok starts in 20 min.
	BATTLE_WITH_BALOK_STARTS_IN_20_MIN(13631),
	BATTLE_WITH_BALOK_STARTS_IN_10_MIN(13632),
	BATTLE_WITH_BALOK_IS_STARTING_SOON(13633),
	MONSTERS_ARE_SPAWNING_ON_THE_BALOK_BATTLEGROUND(13634),
	THREE_BOSSES_HAVE_SPAWNED(13635),
	TWO_BOSSES_HAVE_SPAWNED(13636),
	BALOK_IS_HERE(13637),
	LORD_BALOK_IS_HERE(13638),
	YOU_VE_WON_THE_BATTLE_WITH_BALOK(13639),
	YOU_VE_LOST_THE_BATTLE_WITH_BALOK(13640),
	REQUIRED_LEVEL_FOR_THE_BATTLE_WITH_BALOK_S1(13643),
	TO_GET_A_REWARD_YOU_MUST_BE_OF_LV_S1_AND_GET_AT_LEAST_S2_POINTS(13643),
	REBORN_ZONE_S1(13855),
	WILL_BE_AVAILABLE_IN_THE_NEXT_UPDATE(15001);
