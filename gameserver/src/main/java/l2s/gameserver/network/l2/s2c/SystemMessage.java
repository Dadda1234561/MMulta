...
public class SystemMessage extends L2GameServerPacket
{
	...
	public static final int YOU_NEED_S2_S1_S = 2961; // Вам необходим предмет $s1% в количестве $2 шт.
	...
	public static final int SECRET_SHOP_S1 = 5262; // Секретная лавка $s1

	// Всемирная Торговля Системные Сообщения
	public static final int THE_ITEM_IS_NOT_FOUND = 3373;
	public static final int THE_ITEM_YOU_REGISTERED_HAS_BEEN_SOLD = 3490;
	public static final int THE_REGISTRATION_PERIOD_FOR_THE_ITEM_YOU_REGISTERED_HAS_EXPIRED = 3492;
	public static final int ITEM_TO_BE_TRADED_DOES_NOT_EXIST = 4010;
	public static final int YOU_DO_NOT_HAVE_ENOUGH_L2_COINS_ADD_MORE_L2_COINS_AND_TRY_AGAIN = 6800;
	...
	public static final int YOU_CONSUMED_S1_RAID_POINTS = 4209; // You consumed $s1 Raid Points.
	public static final int NOT_ENOUGH_RAID_POINTS = 4211; // Not enough Raid Points.
	public static final int A_NEW_HOMUNCULUS_IS_CREATED = 13213; // A new homunculus is created
	public static final int THE_HOMUNCULUS_TAKES_YOUR_BLOOD_HP = 13230; // The homunculus takes your blood (HP).
	public static final int THE_HOMUNCULUS_TAKES_YOUR_SPIRIT_SP = 13231; // The homunculus takes your spirit (SP).
	public static final int THE_HOMUNCULUS_TAKES_YOUR_TEARS_VP = 13232; // The homunculus takes your tears (VP).
	public static final int YOUVE_OBTAINED_UPGRADE_POINTS = 13238; // You've obtained upgrade points.
	public static final int THE_HOMUNCULUS_LEVEL_IS_INCREASED = 13239; // The homunculus' level is increased!
	public static final int NOT_ENOUGH_ITEMS_FOR_RESETTING = 13243; // Not enough items for resetting.
	public static final int THE_RECEIVED_UPGRADE_POINTS_ARE_RESET = 13244; // The received upgrade points are reset.
	public static final int THE_RELATIONS_ARE_BEING_ESTABLISHED = 13246; //  The relations are being established.
	public static final int THE_RELATIONS_ARE_BROKEN = 13247; // The relations are broken.
	public static final int NOT_ENOUGH_UPGRADE_POINTS = 13248; // Not enough upgrade points.
	public static final int THE_HOMUNCULUS_IS_DESTROYED = 13252; // The homunculus is destroyed.
	public static final int YOUVE_SEALED_A_HOMUNCULUS_HEART_IN_ORDER_TO_CREATE_IT_YOUR_BLOOD_SPIRIT_AND_TEARS_ARE_REQUIRED = 13254; // You've sealed a homunculus' heart. In order to create it, your blood, spirit and tears are required.
	public static final int YOU_HAVE_REGISTER_FOR_THE_CAPTURE_THE_FLAG_EVENT = 13845; // You Have register for the Capture the Flag Event!
	public static final int YOU_HAVE_CANCELED_YOUR_REGISTRATION_FOR_THE_CAPTURE_THE_FLAG_EVENT = 13846; // You have canceled your registration for the Capture the Flag Event!.
	public static final int VP_ADDED = 13272; // VP added.

	public static final int YOU_CANNOT_LEAVE_WHILE_IN_COMBAT = 13721; // VP added.
		...
		for(Arg e : args)
		{
			...
			switch(e.type)
			{
				...
				case TYPE_SKILL_NAME:
				{
					int[] skill = (int[]) e.obj;
					writeD(skill[0]); // id
					writeH(SkillUtils.getSkillLevelFromMask(skill[1]));
					writeH(SkillUtils.getSubSkillLevelFromMask(skill[1]));
					break;
				}
				case TYPE_LONG:
				{
