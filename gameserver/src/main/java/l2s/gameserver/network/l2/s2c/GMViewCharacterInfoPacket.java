...
public class GMViewCharacterInfoPacket extends L2GameServerPacket
{
	...
	private int _patkspd, evasion, accuracy, crit, _matkspd;
	private Number _mAtk, _pAtk, _pdef;
	...
	{
		return (int) Math.min(Integer.MAX_VALUE, stat.longValue());
	}
}