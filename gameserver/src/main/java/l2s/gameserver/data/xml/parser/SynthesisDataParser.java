...
public class SynthesisDataParser extends AbstractParser<SynthesisDataHolder>
{
	...
	protected void readData(Element rootElement) throws Exception
	{
		for(Iterator<Element> iterator = rootElement.elementIterator("synthesis"); iterator.hasNext();)
		{
			...
			long commission = parseLong(synthesisElement, "commission", 0L);
			...
			getHolder().addData(new SynthesisData(itemId1, itemId2, chance, commission, successItemData, failItemData, resultEffecttype, locationIds));
		}
	}
}
