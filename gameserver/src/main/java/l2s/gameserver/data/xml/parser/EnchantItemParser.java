...
public class EnchantItemParser extends AbstractParser<EnchantItemHolder>
{
	...
	protected void readData(Element rootElement) throws Exception
	{
		...
		for(Iterator<Element> iterator = rootElement.elementIterator("enchant_scroll"); iterator.hasNext();)
		{
			...
			EnchantScroll item = new EnchantScroll(itemId, variation, minEnchant, maxEnchant, enchantType, gradesSet,
					resultType, enchantDropCount, failEffect, minEnchantStep, maxEnchantStep, enchantStepLimit);
