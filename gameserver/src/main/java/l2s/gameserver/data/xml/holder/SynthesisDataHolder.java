...
public final class SynthesisDataHolder extends AbstractHolder
{
	...
	public SynthesisData getData(int itemOneId, int itemTwoId) {
		return _data.stream().filter(data -> data.getItem1Id() == itemOneId && data.getItem2Id() == itemTwoId).findFirst().orElse(null);
	}
