...
public class ChampionTemplateParser extends StatParser<ChampionTemplateHolder> {


    protected ChampionTemplateParser(ChampionTemplateHolder holder)
    {
        super(holder);
    }
    ...
    public File getXMLPath() {
        return new File(Config.DATAPACK_ROOT, "data/champ_stats.xml");
    }

    @Override
    public String getDTDFileName() {
        return "champ_stats.dtd";
    }


    @Override
    protected void readData(Element rootElement) throws Exception {
        for (Element championElement : rootElement.elements("champion")) {
        ...
        for (Element championElement : additionalDrop.elements("champion")) {
    ...
    public static ChampionTemplateParser getInstance() {
        return SingletonHolder.INSTANCE;
    }

    private static class SingletonHolder {
        final protected static ChampionTemplateParser INSTANCE = new ChampionTemplateParser(ChampionTemplateHolder.getInstance());
    }
}
