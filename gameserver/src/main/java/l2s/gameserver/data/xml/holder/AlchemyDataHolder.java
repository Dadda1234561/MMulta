...
public final class AlchemyDataHolder extends AbstractHolder
{
	...
	{
		_datas.put(SkillHolder.getInstance().getHashCode(data.getSkillId(), data.getSkillLevel()), data);
	}
	...
	{
		return _datas.get(SkillHolder.getInstance().getHashCode(skillId, skillLevel));
	}
