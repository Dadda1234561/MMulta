...
public final class TimeRestrictFieldParser extends AbstractParser<TimeRestrictFieldHolder>
{
	...
	protected void readData(Element rootElement) throws Exception 
	{
		for (Iterator<Element> iterator = rootElement.elementIterator("field"); iterator.hasNext();)
		{
			...
			int reflectionId = parseInt(element, "reflectionId");
			...
			getHolder().addTimeRestrictFieldInfo(new TimeRestrictFieldInfo(id, reflectionId, itemId, itemCount, resetCycle, minLevel, maxLevel, remainTimeBase, remainTimeMax, enterX, enterY, enterZ, exitX, exitY, exitZ));
		}
	}
}