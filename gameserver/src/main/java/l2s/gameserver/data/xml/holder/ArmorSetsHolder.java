...
public final class ArmorSetsHolder extends AbstractHolder
{
	...
	public void addArmorSet(ArmorSet armorset)
	{
		...
		for(int id : armorset.getLRingIds())
		{
			List<ArmorSet> sets = _armorSets.get(id);
			if(sets == null)
				sets = new ArrayList<ArmorSet>();
		...
		for(int id : armorset.getRRingIds())
		{
			List<ArmorSet> sets = _armorSets.get(id);
			if(sets == null)
				sets = new ArrayList<ArmorSet>();
		...
		for(int id : armorset.getLEarningIds())
		{
			List<ArmorSet> sets = _armorSets.get(id);
			if(sets == null)
				sets = new ArrayList<ArmorSet>();
		...
		for(int id : armorset.getREarningIds())
		{
			List<ArmorSet> sets = _armorSets.get(id);
			if(sets == null)
				sets = new ArrayList<ArmorSet>();
		...
		for(int id : armorset.getNecklIds())
		{
			List<ArmorSet> sets = _armorSets.get(id);
			if(sets == null)
				sets = new ArrayList<ArmorSet>();
