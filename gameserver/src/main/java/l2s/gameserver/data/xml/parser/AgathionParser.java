...
public final class AgathionParser extends AbstractParser<AgathionHolder>
{
	...
	protected void readData(Element rootElement) throws Exception
	{
		for(Iterator<Element> iterator = rootElement.elementIterator(); iterator.hasNext();)
		{
			...
			boolean delete_on_masters_death = element.attributeValue("delete_on_masters_death") == null || Boolean.parseBoolean(element.attributeValue("delete_on_masters_death"));
			...
			int[] item_ids = element.attributeValue("item_ids") == null ? new int[0] : StringArrayUtils.stringToIntArray(element.attributeValue("item_ids"), ";");
			...
			AgathionTemplate template = new AgathionTemplate(npc_id, id, duration, delay, max_count, use_up, power, target_type, item_ids, energy, max_energy, delete_on_masters_death);
